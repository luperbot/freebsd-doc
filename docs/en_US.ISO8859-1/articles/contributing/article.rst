...
maintainer <#maintain-port>`__. Also read the `Porter's
...
#. **Review and test**
   ...
   -  Make sure your port's dependencies are complete. The recommended
      ...
      `resources <#resources>`__ for more information.
   ...
   -  Verify your port using
      ...
      as a guide. See `resources <#resources>`__ for important
      information about using portlint.
