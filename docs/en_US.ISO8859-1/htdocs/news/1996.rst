...
-  **13-Dec-1996** FreeBSD 2.2-RELEASE will not support installation on
   ...
   the original
   `announcement <../../releases/2.2R/install-media.html>`__ for more
   information.
...
-  **15-Nov-1996** FreeBSD
   `2.1.6-RELEASE <../../releases/2.1.6R/security.html>`__ is out.
   Please see the `release
   notes <../../releases/2.1.6R/security.html>`__ for more information.

-  **4-Nov-1996** The FreeBSD `CVS <http://cvsweb.FreeBSD.org/>`__
   development tree has branched again. `See
   here <../../releases/index.html>`__ for more information.
