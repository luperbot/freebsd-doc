...
The FreeBSD Release Engineering document has been expanded and is now
available as part of the FreeBSD Documentation set. You will find it
`here <../doc/en_US.ISO8859-1/articles/releng/article.html>`__.
