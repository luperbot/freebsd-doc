...
replaced by a newer
`sconfig(8) <http://www.FreeBSD.org/cgi/man.cgi?query=sconfig&sektion=8&manpath=FreeBSD+5.2-RELEASE>`__
utility.
...
.. raw:: html
    ...
    **Warning:** This driver should be considered experimental and and
