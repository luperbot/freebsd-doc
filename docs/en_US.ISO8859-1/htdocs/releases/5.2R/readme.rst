...
| $FreeBSD: src/release/doc/en\_US.ISO8859-1/readme/article.sgml,v 1.27
  2003/09/08 14:53:02 simon Exp $
...
.. raw:: html
    ...
    This document gives a brief introduction to FreeBSD 5.2-RELEASE. It
...
This distribution is a release of FreeBSD 5.2-RELEASE, the latest point
...
-  ``EARLY.TXT``: A guide for early adopters of FreeBSD 5.2-RELEASE.
...
-  ``RELNOTES.TXT``: The release notes, showing what's new and different
   in FreeBSD 5.2-RELEASE compared to the previous release (FreeBSD
   5.1-RELEASE).
