==================================================
FreeBSD/i386 6.4-RELEASE Installation Instructions
==================================================
...
.. raw:: html
    ...
    FreeBSD/i386 6.4-RELEASE, with particular emphasis given to
...
obtaining the FreeBSD 6.4-RELEASE distribution and to beginning the
...
`dd(1) <http://www.FreeBSD.org/cgi/man.cgi?query=dd&sektion=1&manpath=FreeBSD+6.4-RELEASE>`__
command in UNIX.
...
-  If you would be able to FTP install FreeBSD directly from the CDROM
   ...
   `vipw(8) <http://www.FreeBSD.org/cgi/man.cgi?query=vipw&sektion=8&manpath=FreeBSD+6.4-RELEASE>`__
   command):
...
`disklabel(8) <http://www.FreeBSD.org/cgi/man.cgi?query=disklabel&sektion=8&manpath=FreeBSD+6.4-RELEASE>`__
and
`newfs(8) <http://www.FreeBSD.org/cgi/man.cgi?query=newfs&sektion=8&manpath=FreeBSD+6.4-RELEASE>`__
...
`tar(1) <http://www.FreeBSD.org/cgi/man.cgi?query=tar&sektion=1&manpath=FreeBSD+6.4-RELEASE>`__
...
`doscmd(1) <http://www.FreeBSD.org/cgi/man.cgi?query=doscmd&sektion=1&manpath=FreeBSD+6.4-RELEASE>`__
...
#. The ``packages`` and ``ports`` directories contain the FreeBSD
   ...
   ``packages``/ to the
   `pkg\_add(1) <http://www.FreeBSD.org/cgi/man.cgi?query=pkg_add&sektion=1&manpath=FreeBSD+6.4-RELEASE>`__
   command.
...
`mtree(8) <http://www.FreeBSD.org/cgi/man.cgi?query=mtree&sektion=8&manpath=FreeBSD+6.4-RELEASE>`__
...
.. raw:: html
    ...
    **Important:** These notes assume that you are using the version of
    `sysinstall(8) <http://www.FreeBSD.org/cgi/man.cgi?query=sysinstall&sektion=8&manpath=FreeBSD+6.4-RELEASE>`__
