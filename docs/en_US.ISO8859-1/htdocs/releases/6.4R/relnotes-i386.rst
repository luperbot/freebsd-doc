======================================
FreeBSD/i386 6.4-RELEASE Release Notes
======================================
...
The BTX kernel used by the boot loader has been changed to invoke BIOS
routines from real mode. This change makes it possible to boot FreeBSD
from USB devices.
