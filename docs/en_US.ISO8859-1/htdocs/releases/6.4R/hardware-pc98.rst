=======================================
FreeBSD/pc98 6.4-RELEASE Hardware Notes
=======================================
...
6.4-RELEASE on the NEC PC-98x1 hardware platform (also referred to as
FreeBSD/pc98 6.4-RELEASE). It lists devices known to work on this
...
The
`ct(4) <http://www.FreeBSD.org/cgi/man.cgi?query=ct&sektion=4&manpath=FreeBSD+6.4-RELEASE>`__
...
The
`snc(4) <http://www.FreeBSD.org/cgi/man.cgi?query=snc&sektion=4&manpath=FreeBSD+6.4-RELEASE>`__
...
(`sb(4) <http://www.FreeBSD.org/cgi/man.cgi?query=sb&sektion=4&manpath=FreeBSD+6.4-RELEASE>`__
driver)
