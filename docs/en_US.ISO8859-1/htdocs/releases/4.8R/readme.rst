...
| $FreeBSD: src/release/doc/en\_US.ISO8859-1/readme/article.sgml,v
  1.1.2.16 2003/01/06 22:09:00 bmah Exp $
...
.. raw:: html
    ...
    This document gives a brief introduction to FreeBSD 4.8-RELEASE. It
...
This distribution is a release of FreeBSD 4.8-RELEASE, the latest point
...
a piece of software, with a single command. Over 8,300 ports, from
...
Page <http://lists.FreeBSD.org/mailman/listinfo>`__. This will give you
...
-  ``RELNOTES.TXT``: The release notes, showing what's new and different
   in FreeBSD 4.8-RELEASE compared to the previous release (FreeBSD
   4.7-RELEASE).
