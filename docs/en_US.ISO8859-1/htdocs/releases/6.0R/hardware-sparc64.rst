==========================================
FreeBSD/sparc64 6.0-RELEASE Hardware Notes
==========================================
...
6.0-RELEASE on the UltraSPARC hardware platform (also referred to as
FreeBSD/sparc64 6.0-RELEASE). It lists devices known to work on this
...
tested with FreeBSD 6.0-RELEASE. We encourage you to try it and send a
...
The
`esp(4) <http://www.FreeBSD.org/cgi/man.cgi?query=esp&sektion=4&manpath=FreeBSD+6.0-RELEASE>`__
...
Cards supported by
`gem(4) <http://www.FreeBSD.org/cgi/man.cgi?query=gem&sektion=4&manpath=FreeBSD+6.0-RELEASE>`__
driver include:
