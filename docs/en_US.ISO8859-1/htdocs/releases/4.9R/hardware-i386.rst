...
3.3 `FDDI Interfaces <#AEN1342>`__
3.4 `ATM Interfaces <#AEN1352>`__
3.5 `Wireless Network Interfaces <#AEN1394>`__
3.6 `Miscellaneous Networks <#AEN1522>`__
3.7 `ISDN Interfaces <#AEN1539>`__
3.8 `Multi-port Serial Interfaces <#AEN1603>`__
3.9 `Audio Devices <#AEN1735>`__
3.10 `Camera and Video Capture Devices <#AEN1838>`__
3.11 `USB Devices <#USB>`__
3.12 `IEEE 1394 (Firewire) Devices <#FIREWIRE>`__
3.13 `Cryptographic Accelerators <#AEN2099>`__
3.14 `Miscellaneous <#AEN2124>`__
...
4.9-RELEASE on the i386 hardware platform (also referred to as
FreeBSD/i386 4.9-RELEASE). It lists devices known to work on this
...
(`ahd(4) <http://www.FreeBSD.org/cgi/man.cgi?query=ahd&sektion=4&manpath=FreeBSD+4.9-RELEASE>`__
driver)
...
`cam(4) <http://www.FreeBSD.org/cgi/man.cgi?query=cam&sektion=4&manpath=FreeBSD+4.9-RELEASE>`__
SCSI subsystem:
