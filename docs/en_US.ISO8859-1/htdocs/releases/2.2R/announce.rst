...
CDROM <http://www.cdrom.com/>`__, from where it will be shipping
shortly.
...
`release notes <../../releases/2.2R/notes.html>`__ for a list of new
features.
