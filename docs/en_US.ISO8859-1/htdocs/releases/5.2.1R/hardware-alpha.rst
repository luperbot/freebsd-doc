==========================================
FreeBSD/alpha 5.2.1-RELEASE Hardware Notes
==========================================
...
3.1 `Disk Controllers <#AEN1448>`__
3.2 `Ethernet Interfaces <#ETHERNET>`__
3.3 `FDDI Interfaces <#AEN2169>`__
3.4 `ATM Interfaces <#AEN2179>`__
3.5 `Wireless Network Interfaces <#AEN2198>`__
3.6 `Miscellaneous Networks <#AEN2224>`__
3.7 `ISDN Interfaces <#AEN2247>`__
3.8 `Serial Interfaces <#AEN2311>`__
3.9 `Audio Devices <#AEN2484>`__
3.10 `Camera and Video Capture Devices <#AEN2606>`__
3.11 `USB Devices <#USB>`__
3.12 `IEEE 1394 (Firewire) Devices <#FIREWIRE>`__
3.13 `Bluetooth Devices <#BLUETOOTH>`__
3.14 `Cryptographic Accelerators <#AEN2834>`__
3.15 `Miscellaneous <#AEN2852>`__
...
5.2.1-RELEASE on the Alpha/AXP hardware platform (also referred to as
FreeBSD/alpha 5.2.1-RELEASE). It lists devices known to work on this
...
.. raw:: html
    ...
    **Note:** Contrary to expectation there is no cpu EV6 defined for
    ...
    keep
    `config(8) <http://www.FreeBSD.org/cgi/man.cgi?query=config&sektion=8&manpath=FreeBSD+5.2.1-RELEASE>`__
    happy.
