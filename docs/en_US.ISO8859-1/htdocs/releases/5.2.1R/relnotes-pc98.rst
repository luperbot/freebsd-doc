========================================
FreeBSD/pc98 5.2.1-RELEASE Release Notes
========================================
...
the NEC PC-98x1 hardware platform. It describes recently added, changed,
or deleted features of FreeBSD. It also provides some notes on upgrading
...
improve interrupt routing and handling.
...
[5.2.1] ``libdisk`` now uses the correct PC98 disk partition value for
FreeBSD. This permits the
