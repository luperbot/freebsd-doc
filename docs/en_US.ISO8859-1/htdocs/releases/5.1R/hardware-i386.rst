=======================================
FreeBSD/i386 5.1-RELEASE Hardware Notes
=======================================
...
3.1 `Disk Controllers <#AEN63>`__
3.2 `Ethernet Interfaces <#ETHERNET>`__
3.3 `FDDI Interfaces <#AEN1629>`__
3.4 `ATM Interfaces <#AEN1639>`__
3.5 `Wireless Network Interfaces <#AEN1683>`__
3.6 `Miscellaneous Networks <#AEN1811>`__
3.7 `ISDN Interfaces <#AEN1842>`__
3.8 `Serial Interfaces <#AEN1906>`__
3.9 `Audio Devices <#AEN2101>`__
3.10 `Camera and Video Capture Devices <#AEN2224>`__
3.11 `USB Devices <#USB>`__
3.12 `IEEE 1394 (Firewire) Devices <#FIREWIRE>`__
3.13 `Bluetooth Devices <#BLUETOOTH>`__
3.14 `Cryptographic Accelerators <#AEN2604>`__
3.15 `Miscellaneous <#AEN2629>`__
...
5.1-RELEASE on the i386 hardware platform (also referred to as
FreeBSD/i386 5.1-RELEASE). It lists devices known to work on this
...
scheduling can result in suboptimal performance, the logical CPUs are
...
`cam(4) <http://www.FreeBSD.org/cgi/man.cgi?query=cam&sektion=4&manpath=FreeBSD+5.1-release>`__
SCSI subsystem:
...
-  Cisco Systems Aironet 340 and 350 series (PCMCIA, PCI, Mini-PCI, and
   ISA adapters are all supported)
