...
can be found at ftp://ftp.FreeBSD.org/pub/FreeBSD/development/sparc64/
or any of its mirrors. More information on obtaining this (or other)
...
The sunlabel utility, a program analogous to
`bsdlabel(8) <http://www.FreeBSD.org/cgi/man.cgi?query=bsdlabel&sektion=8&manpath=FreeBSD+5.1-release>`__
that works on Sun disk labels, has been added.
