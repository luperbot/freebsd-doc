========================================
FreeBSD/alpha 5.1-RELEASE Hardware Notes
========================================
...
3.1 `Disk Controllers <#AEN1446>`__
3.2 `Ethernet Interfaces <#ETHERNET>`__
3.3 `FDDI Interfaces <#AEN3012>`__
3.4 `ATM Interfaces <#AEN3022>`__
3.5 `Wireless Network Interfaces <#AEN3066>`__
3.6 `Miscellaneous Networks <#AEN3194>`__
3.7 `ISDN Interfaces <#AEN3225>`__
3.8 `Serial Interfaces <#AEN3289>`__
3.9 `Audio Devices <#AEN3484>`__
3.10 `Camera and Video Capture Devices <#AEN3607>`__
3.11 `USB Devices <#USB>`__
3.12 `IEEE 1394 (Firewire) Devices <#FIREWIRE>`__
3.13 `Bluetooth Devices <#BLUETOOTH>`__
3.14 `Cryptographic Accelerators <#AEN3987>`__
3.15 `Miscellaneous <#AEN4012>`__
...
5.1-RELEASE on the Alpha/AXP hardware platform (also referred to as
FreeBSD/alpha 5.1-RELEASE). It lists devices known to work on this
...
`pcm(4) <http://www.FreeBSD.org/cgi/man.cgi?query=pcm&sektion=4&manpath=FreeBSD+5.1-release>`__
...
on/off remotely, reset it etc. See also the description for RMC in the
DS10 section of this document. RCM versus RMC is not a typo, the various
documentation I consulted used both acronyms interchangably.
...
(`amr(4) <http://www.FreeBSD.org/cgi/man.cgi?query=amr&sektion=4&manpath=FreeBSD+5.1-release>`__
driver)
...
firmware
(`mlx(4) <http://www.FreeBSD.org/cgi/man.cgi?query=mlx&sektion=4&manpath=FreeBSD+5.1-release>`__
driver)
...
(`sk(4) <http://www.FreeBSD.org/cgi/man.cgi?query=sk&sektion=4&manpath=FreeBSD+5.1-release>`__
drivers)
...
(`rp(4) <http://www.FreeBSD.org/cgi/man.cgi?query=rp&sektion=4&manpath=FreeBSD+5.1-release>`__
driver)
...
-  ES1868, ES1869, ES1879 and ES1888
   (`sbc(4) <http://www.FreeBSD.org/cgi/man.cgi?query=sbc&sektion=4&manpath=FreeBSD+5.1-release>`__
   driver)
