==========================================
FreeBSD/sparc64 6.1-RELEASE Hardware Notes
==========================================
...
2.1 `Fully Supported Systems <#AEN27>`__
2.2 `Partially Supported Systems <#AEN81>`__
2.3 `Unsupported Systems <#AEN89>`__
...
6.1-RELEASE on the UltraSPARC hardware platform (also referred to as
FreeBSD/sparc64 6.1-RELEASE). It lists devices known to work on this
...
tested with FreeBSD 6.1-RELEASE. We encourage you to try it and send a
...
The
`esp(4) <http://www.FreeBSD.org/cgi/man.cgi?query=esp&sektion=4&manpath=FreeBSD+6.1-RELEASE>`__
...
Cards supported by
`gem(4) <http://www.FreeBSD.org/cgi/man.cgi?query=gem&sektion=4&manpath=FreeBSD+6.1-RELEASE>`__
driver include:
...
The
`snd\_audiocs(4) <http://www.FreeBSD.org/cgi/man.cgi?query=snd_audiocs&sektion=4&manpath=FreeBSD+6.1-RELEASE>`__
