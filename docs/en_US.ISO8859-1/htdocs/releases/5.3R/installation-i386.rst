...
.. raw:: html
    ...
    FreeBSD/i386 5.3-RELEASE, with particular emphasis given to
...
obtaining the FreeBSD 5.3-RELEASE distribution and to beginning the
...
and at least 8 megs of RAM to install and 7 megs to run. You will need
at least 150MB of free hard drive space for the most minimal
installation. See below for ways of shrinking existing DOS partitions in
order to install FreeBSD.
...
release\ ``/floppies/kernX.flp`` files from ftp://ftp.FreeBSD.org/ or
one of the many mirrors listed at `FTP
...
.. raw:: html
    ...
    **Warning:** Binary upgrades to FreeBSD 5.3-RELEASE from FreeBSD
...
boot menu each time but the boot won't go any further. <#Q4.2.5.>`__
...
FreeBSD is on BIOS disk 1, of type ad and the FreeBSD disk number is 2,
so you would say:
