...
.. raw:: html
    ...
    This document gives a brief introduction to FreeBSD 5.3-RELEASE. It
...
This distribution is a release of FreeBSD 5.3-RELEASE, the latest point
...
-  ``EARLY.TXT``: A migration guide for users of FreeBSD 4.X who are new
   to FreeBSD 5.X series of releases.

-  ``RELNOTES.TXT``: The release notes, showing what's new and different
   in FreeBSD 5.3-RELEASE compared to the previous release (FreeBSD
   5.2.1-RELEASE).
