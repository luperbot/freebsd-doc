=======================================
FreeBSD/pc98 5.3-RELEASE Hardware Notes
=======================================
...
5.3-RELEASE on the NEC PC-98x1 hardware platform (also referred to as
FreeBSD/pc98 5.3-RELEASE). It lists devices known to work on this
...
The
`ct(4) <http://www.FreeBSD.org/cgi/man.cgi?query=ct&sektion=4&manpath=FreeBSD+5.3-RELEASE>`__
...
The
`snc(4) <http://www.FreeBSD.org/cgi/man.cgi?query=snc&sektion=4&manpath=FreeBSD+5.3-RELEASE>`__
driver supports the following cards:
...
(`sb(4) <http://www.FreeBSD.org/cgi/man.cgi?query=sb&sektion=4&manpath=FreeBSD+5.3-RELEASE>`__
driver)
