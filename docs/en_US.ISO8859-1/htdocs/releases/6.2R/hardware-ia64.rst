=======================================
FreeBSD/ia64 6.2-RELEASE Hardware Notes
=======================================
...
6.2-RELEASE on the IA-64 hardware platform (also referred to as
FreeBSD/ia64 6.2-RELEASE). It lists devices known to work on this
...
`syscons(4) <http://www.FreeBSD.org/cgi/man.cgi?query=syscons&sektion=4&manpath=FreeBSD+6.2-RELEASE>`__
