==========================================
FreeBSD/sparc64 6.2-RELEASE Hardware Notes
==========================================
...
6.2-RELEASE on the UltraSPARC hardware platform (also referred to as
FreeBSD/sparc64 6.2-RELEASE). It lists devices known to work on this
...
tested with FreeBSD 6.2-RELEASE. We encourage you to try it and send a
...
The
`esp(4) <http://www.FreeBSD.org/cgi/man.cgi?query=esp&sektion=4&manpath=FreeBSD+6.2-RELEASE>`__
...
`gem(4) <http://www.FreeBSD.org/cgi/man.cgi?query=gem&sektion=4&manpath=FreeBSD+6.2-RELEASE>`__
driver include:
...
The
`snd\_audiocs(4) <http://www.FreeBSD.org/cgi/man.cgi?query=snd_audiocs&sektion=4&manpath=FreeBSD+6.2-RELEASE>`__
