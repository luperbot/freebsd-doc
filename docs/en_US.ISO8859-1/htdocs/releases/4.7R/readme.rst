...
.. raw:: html
    ...
    This document gives a brief introduction to FreeBSD 4.7-RELEASE. It
...
This distribution is a release of FreeBSD 4.7-RELEASE, the latest point
...
-  ``RELNOTES.TXT``: The release notes, showing what's new and different
   in FreeBSD 4.7-RELEASE compared to the previous release (FreeBSD
   4.6-RELEASE).
