...
| $FreeBSD: src/release/doc/en\_US.ISO8859-1/readme/article.sgml,v
  1.1.2.18.2.1 2005/01/21 02:52:24 hrs Exp $
...
.. raw:: html
    ...
    This document gives a brief introduction to FreeBSD 4.11-RELEASE. It
...
This distribution is a release of FreeBSD 4.11-RELEASE, the latest point
...
a piece of software, with a single command. Over 11,800 ports, from
...
`send-pr(1) <http://www.FreeBSD.org/cgi/man.cgi?query=send-pr&sektion=1&manpath=FreeBSD+4.11-RELEASE>`__
...
-  ``RELNOTES.TXT``: The release notes, showing what's new and different
   in FreeBSD 4.11-RELEASE compared to the previous release (FreeBSD
   4.10-RELEASE).
...
`man(1) <http://www.FreeBSD.org/cgi/man.cgi?query=man&sektion=1&manpath=FreeBSD+4.11-RELEASE>`__
...
`tuning(7) <http://www.FreeBSD.org/cgi/man.cgi?query=tuning&sektion=7&manpath=FreeBSD+4.11-RELEASE>`__
(a guide to performance tuning),
`security(7) <http://www.FreeBSD.org/cgi/man.cgi?query=security&sektion=7&manpath=FreeBSD+4.11-RELEASE>`__
(an introduction to FreeBSD security), and
`style(9) <http://www.FreeBSD.org/cgi/man.cgi?query=style&sektion=9&manpath=FreeBSD+4.11-RELEASE>`__
