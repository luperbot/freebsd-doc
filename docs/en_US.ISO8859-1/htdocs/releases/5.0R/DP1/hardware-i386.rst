...
3.3 `FDDI Interfaces <#AEN1245>`__
3.4 `ATM Interfaces <#AEN1255>`__
3.5 `Wireless Network Interfaces <#AEN1297>`__
3.6 `Miscellaneous Networks <#AEN1374>`__
3.7 `ISDN Interfaces <#AEN1384>`__
3.8 `Multi-port Serial Interfaces <#AEN1448>`__
3.9 `Audio Devices <#AEN1543>`__
3.10 `Camera and Video Capture Devices <#AEN1645>`__
3.11 `USB Devices <#USB>`__
3.12 `Miscellaneous <#AEN1824>`__
...
5.0-DP1 on the IA-32 hardware platform (also referred to as FreeBSD/i386
5.0-DP1). It lists devices known to work on this platform, as well as
