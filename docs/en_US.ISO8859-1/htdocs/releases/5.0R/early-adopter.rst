...
| $FreeBSD:
  src/release/doc/en\_US.ISO8859-1/early-adopter/article.sgml,v 1.8.2.3
  2003/01/14 18:12:49 roam Exp $
...
-  GCC: The compiler toolchain is now based on GCC 3.2.1, rather than
   GCC 2.95.\ ``X``.
...
-  Documentation (such as the FreeBSD
   ...
   may not reflect changes recently made to FreeBSD 5.0.
...
4.8-RELEASE, currently scheduled for 1 March 2003.
...
in 5.0. These obsolete files may create some problems.
...
`device.hints(5) <http://www.FreeBSD.org/cgi/man.cgi?query=device.hints&sektion=5&manpath=FreeBSD+5.0-RELEASE>`__
...
notable new features of the 5.\ ``X`` series, and some drawbacks to
