=======================================
FreeBSD/alpha 5.0-RELEASE Release Notes
=======================================
...
Support for TurboChannel Alphas has been removed.
...
`timed(8) <http://www.FreeBSD.org/cgi/man.cgi?query=timed&sektion=8&manpath=FreeBSD+5.0-RELEASE>`__
