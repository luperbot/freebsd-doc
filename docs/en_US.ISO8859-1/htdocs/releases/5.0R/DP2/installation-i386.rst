==============================================
FreeBSD/i386 5.0-DP2 Installation Instructions
==============================================
...
.. raw:: html
    ...
    FreeBSD/i386 5.0-DP2, with particular emphasis given to obtaining a
...
obtaining the FreeBSD 5.0-DP2 distribution and to beginning the
...
http://snapshots.jp.FreeBSD.org/ or one of the many mirrors listed at
`FTP
...
.. raw:: html
    ...
    **Warning:** Binary upgrades to FreeBSD 5.0-DP2 from FreeBSD
...
4.2 Common Installation Problems for IA-32 Architecture Users
-------------------------------------------------------------
...
4.2.3. `The mcd(4) driver keeps thinking that it has found a device and
this stops my Intel EtherExpress card from working. <#Q4.2.3.>`__
4.2.4. `The system finds my ed(4) network card, but I keep getting
device timeout errors. <#Q4.2.4.>`__
4.2.5. `I booted the install floppy on my IBM ThinkPad (tm) laptop, and
the keyboard is all messed up. <#Q4.2.5.>`__
4.2.6. `My system can not find my Intel EtherExpress 16
card. <#Q4.2.6.>`__
4.2.7. `When installing on an EISA HP Netserver, my on-board AIC-7xxx
SCSI controller isn't detected. <#Q4.2.7.>`__
4.2.8. `I have a Panasonic AL-N1 or Rios Chandler Pentium machine and I
find that the system hangs before ever getting into the installation
now. <#Q4.2.8.>`__
4.2.9. `I have this CMD640 IDE controller that is said to be
broken. <#Q4.2.9.>`__
4.2.10. `On a Compaq Aero notebook, I get the message \`\`No floppy
devices found! Please check ...'' when trying to install from
floppy. <#Q4.2.10.>`__
4.2.11. `When installing on an Dell Poweredge XE, Dell proprietary RAID
controller DSA (Dell SCSI Array) isn't recognized. <#Q4.2.11.>`__
4.2.12. `I have an IBM EtherJet PCI card, it is detected by the fxp(4)
driver correctly, but the lights on the card don't come on and it
doesn't connect to the network. <#Q4.2.12.>`__
4.2.13. `When I configure the network during installation on an IBM
Netfinity 3500, the system freezes. <#Q4.2.13.>`__
4.2.14. `When I install onto a drive managed by a Mylex PCI RAID
...
**4.2.3.** The mcd(4) driver keeps thinking that it has found a device
...
**4.2.5.** I booted the install floppy on my IBM ThinkPad (tm) laptop,
...
**4.2.6.** My system can not find my Intel EtherExpress 16 card.
...
**4.2.8.** I have a Panasonic AL-N1 or Rios Chandler Pentium machine and
I find that the system hangs before ever getting into the installation
now.
...
**4.2.9.** I have this CMD640 IDE controller that is said to be broken.
...
**4.2.11.** When installing on an Dell Poweredge XE, Dell proprietary
...
**4.2.12.** I have an IBM EtherJet PCI card, it is detected by the
