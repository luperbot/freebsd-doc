====================================
FreeBSD/alpha 5.0-DP2 Hardware Notes
====================================
...
2.3.3 `Personal Workstation (\`\`Miata'') <#AEN273>`__
2.3.4 `Evaluation Board 64 family <#AEN383>`__
...
\`\`Bret'' for EV56) <#AEN568>`__
2.3.8 `AlphaServer 1000 (\`\`Mikasa''), 1000A (\`\`Noritake'') and
800(\`\`Corelle'') <#AEN679>`__
2.3.9 `DS10/VS10/XP900 (\`\`Webbrick'') / XP1000 (\`\`Monet'') / DS10L
(\`\`Slate'') <#AEN735>`__
2.3.10 `DS20/DS20E (\`\`Goldrush'') <#AEN886>`__
2.3.11 `AlphaPC 264DP / UP2000 <#AEN955>`__
2.3.12 `AlphaServer 2000 (\`\`DemiSable''), 2100 (\`\`Sable''), 2100A
(\`\`Lynx'') <#AEN1001>`__
2.3.13 `AlphaServer 4x00 (\`\`Rawhide'') <#AEN1072>`__
2.3.14 `AlphaServer 1200 (\`\`Tincup'') and AlphaStation 1200
(\`\`DaVinci'') <#AEN1103>`__
2.3.15 `AlphaServer 8200 and 8400 (\`\`TurboLaser'') <#AEN1133>`__
2.3.16 `Alpha Processor Inc. UP1000 <#AEN1176>`__
2.3.17 `Alpha Processor Inc. UP1100 <#AEN1225>`__
2.3.18 `Alpha Processor Inc. CS20, Compaq DS20L <#AEN1273>`__
2.4 `Supported Hardware Overview <#AEN1320>`__
2.5 `Acknowledgments <#AEN1352>`__
3 `Supported Devices <#AEN1393>`__
3.1 `Disk Controllers <#AEN1399>`__
3.2 `Ethernet Interfaces <#ETHERNET>`__
3.3 `FDDI Interfaces <#AEN2866>`__
3.4 `ATM Interfaces <#AEN2876>`__
3.5 `Wireless Network Interfaces <#AEN2918>`__
3.6 `Miscellaneous Networks <#AEN3043>`__
3.7 `ISDN Interfaces <#AEN3053>`__
3.8 `Serial Interfaces <#AEN3117>`__
3.9 `Audio Devices <#AEN3277>`__
3.10 `Camera and Video Capture Devices <#AEN3403>`__
3.11 `USB Devices <#USB>`__
3.12 `IEEE 1394 (Firewire) Devices <#FIREWIRE>`__
3.13 `Cryptographic Accelerators <#AEN3660>`__
3.14 `Miscellaneous <#AEN3685>`__
...
5.0-DP2 on the Alpha/AXP hardware platform (also referred to as
FreeBSD/alpha 5.0-DP2). It lists devices known to work on this platform,
