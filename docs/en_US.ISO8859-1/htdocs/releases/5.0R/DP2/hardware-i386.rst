===================================
FreeBSD/i386 5.0-DP2 Hardware Notes
===================================
...
3.3 `FDDI Interfaces <#AEN1499>`__
3.4 `ATM Interfaces <#AEN1509>`__
3.5 `Wireless Network Interfaces <#AEN1551>`__
3.6 `Miscellaneous Networks <#AEN1676>`__
3.7 `ISDN Interfaces <#AEN1686>`__
3.8 `Serial Interfaces <#AEN1750>`__
3.9 `Audio Devices <#AEN1910>`__
3.10 `Camera and Video Capture Devices <#AEN2036>`__
3.11 `USB Devices <#USB>`__
3.12 `IEEE 1394 (Firewire) Devices <#FIREWIRE>`__
3.13 `Cryptographic Accelerators <#AEN2293>`__
3.14 `Miscellaneous <#AEN2318>`__
...
5.0-DP2 on the IA-32 hardware platform (also referred to as FreeBSD/i386
5.0-DP2). It lists devices known to work on this platform, as well as
some notes on boot-time kernel customization that may be useful when
...
-  Adaptec 154x series ISA SCSI controllers
   (`aha(4) <http://www.FreeBSD.org/cgi/man.cgi?query=aha&sektion=4&manpath=FreeBSD+5.0-current>`__
   driver)
...
-  Adaptec 174x series EISA SCSI controller in standard and enhanced
   ...
   (`aha(4) <http://www.FreeBSD.org/cgi/man.cgi?query=aha&sektion=4&manpath=FreeBSD+5.0-current>`__
   and
   `ahb(4) <http://www.FreeBSD.org/cgi/man.cgi?query=ahb&sektion=4&manpath=FreeBSD+5.0-current>`__
   driver)
...
(`bt(4) <http://www.FreeBSD.org/cgi/man.cgi?query=bt&sektion=4&manpath=FreeBSD+5.0-current>`__
driver):
...
(`dpt(4) <http://www.FreeBSD.org/cgi/man.cgi?query=dpt&sektion=4&manpath=FreeBSD+5.0-current>`__
driver)
...
(`vpo(4) <http://www.FreeBSD.org/cgi/man.cgi?query=vpo&sektion=4&manpath=FreeBSD+5.0-current>`__
driver)
...
-  Sony proprietary interface (all models)
   (`scd(4) <http://www.FreeBSD.org/cgi/man.cgi?query=scd&sektion=4&manpath=FreeBSD+5.0-current>`__)
...
-  Mitsumi proprietary CD-ROM interface (all models)
   (`mcd(4) <http://www.FreeBSD.org/cgi/man.cgi?query=mcd&sektion=4&manpath=FreeBSD+5.0-current>`__)
...
(`rdp(4) <http://www.FreeBSD.org/cgi/man.cgi?query=rdp&sektion=4&manpath=FreeBSD+5.0-current>`__
driver)
...
(`le(4) <http://www.FreeBSD.org/cgi/man.cgi?query=le&sektion=4&manpath=FreeBSD+5.0-current>`__
driver)
...
(`ex(4) <http://www.FreeBSD.org/cgi/man.cgi?query=ex&sektion=4&manpath=FreeBSD+5.0-current>`__
driver)
...
(`ie(4) <http://www.FreeBSD.org/cgi/man.cgi?query=ie&sektion=4&manpath=FreeBSD+5.0-current>`__
driver)
...
(`cs(4) <http://www.FreeBSD.org/cgi/man.cgi?query=cs&sektion=4&manpath=FreeBSD+5.0-current>`__
driver)
...
(`wl(4) <http://www.FreeBSD.org/cgi/man.cgi?query=wl&sektion=4&manpath=FreeBSD+5.0-current>`__
driver)
...
ARNET serial cards
(`ar(4) <http://www.FreeBSD.org/cgi/man.cgi?query=ar&sektion=4&manpath=FreeBSD+5.0-current>`__
driver)
...
(`cy(4) <http://www.FreeBSD.org/cgi/man.cgi?query=cy&sektion=4&manpath=FreeBSD+5.0-current>`__
driver)

STB 4 port card using shared IRQ

DigiBoard intelligent serial cards
(`dgb(4) <http://www.FreeBSD.org/cgi/man.cgi?query=dgb&sektion=4&manpath=FreeBSD+5.0-current>`__
driver)
...
-  SDL Communications RISCom/N2 and N2pci high-speed sync serial boards
   (`sr(4) <http://www.FreeBSD.org/cgi/man.cgi?query=sr&sektion=4&manpath=FreeBSD+5.0-current>`__
   driver)

Stallion Technologies multiport serial boards

-  EasyIO
   (`stl(4) <http://www.FreeBSD.org/cgi/man.cgi?query=stl&sektion=4&manpath=FreeBSD+5.0-current>`__
   driver)
...
-  EasyConnection 8/64
   (`stli(4) <http://www.FreeBSD.org/cgi/man.cgi?query=stli&sektion=4&manpath=FreeBSD+5.0-current>`__
   driver)
...
(`si(4) <http://www.FreeBSD.org/cgi/man.cgi?query=si&sektion=4&manpath=FreeBSD+5.0-current>`__
driver)
...
(`csa(4) <http://www.FreeBSD.org/cgi/man.cgi?query=csa&sektion=4&manpath=FreeBSD+5.0-current>`__
driver)
...
Gravis
(`gusc(4) <http://www.FreeBSD.org/cgi/man.cgi?query=gusc&sektion=4&manpath=FreeBSD+5.0-current>`__
driver)
...
(`meteor(4) <http://www.FreeBSD.org/cgi/man.cgi?query=meteor&sektion=4&manpath=FreeBSD+5.0-current>`__
driver)
...
(`tw(4) <http://www.FreeBSD.org/cgi/man.cgi?query=tw&sektion=4&manpath=FreeBSD+5.0-current>`__
driver)
