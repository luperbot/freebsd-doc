======================================
FreeBSD/sparc64 5.0-DP2 Hardware Notes
======================================
...
2 `Supported Systems <#AEN15>`__
2.1 `Overview <#AEN18>`__
2.2 `In general, what do you need to run FreeBSD on a
sparc64 <#AEN29>`__
2.3 `System-specific information <#AEN56>`__
2.3.1 `Ultra 1 <#AEN60>`__
2.3.2 `Ultra 2 <#AEN64>`__
2.3.3 `Ultra 5/10 <#AEN81>`__
2.3.4 `Ultra 60 <#AEN109>`__
2.3.5 `Blade 100 <#AEN133>`__
2.4 `Supported Hardware Overview <#AEN172>`__
3 `Supported Devices <#AEN195>`__
3.1 `PCI Hardware <#AEN201>`__
3.2 `SBus Hardware <#AEN239>`__
3.3 `ISA Hardware <#AEN249>`__
3.4 `EBus Hardware <#AEN259>`__
3.5 `Unsupported Hardware <#AEN272>`__
4 `Acknowledgments <#AEN300>`__
...
5.0-DP2 on the UltraSPARC hardware platform (also referred to as
FreeBSD/sparc64 5.0-DP2). It lists devices known to work on this
...
-  `sym(4) <http://www.FreeBSD.org/cgi/man.cgi?query=sym&sektion=4&manpath=FreeBSD+5.0-current>`__-based
...
$FreeBSD:
src/release/doc/en\_US.ISO8859-1/hardware/sparc64/dev-sparc64.sgml,v 1.1
