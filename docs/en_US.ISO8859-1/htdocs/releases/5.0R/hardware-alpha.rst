========================================
FreeBSD/alpha 5.0-RELEASE Hardware Notes
========================================
...
\`\`Bret'' for EV56) <#AEN571>`__
2.3.8 `AlphaServer 1000 (\`\`Mikasa''), 1000A (\`\`Noritake'') and
800(\`\`Corelle'') <#AEN683>`__
2.3.9 `DS10/VS10/XP900 (\`\`Webbrick'') / XP1000 (\`\`Monet'') / DS10L
(\`\`Slate'') <#AEN739>`__
2.3.10 `DS20/DS20E (\`\`Goldrush'') <#AEN890>`__
2.3.11 `AlphaPC 264DP / UP2000 <#AEN959>`__
2.3.12 `AlphaServer 2000 (\`\`DemiSable''), 2100 (\`\`Sable''), 2100A
(\`\`Lynx'') <#AEN1005>`__
2.3.13 `AlphaServer 4x00 (\`\`Rawhide'') <#AEN1076>`__
2.3.14 `AlphaServer 1200 (\`\`Tincup'') and AlphaStation 1200
(\`\`DaVinci'') <#AEN1107>`__
2.3.15 `AlphaServer 8200 and 8400 (\`\`TurboLaser'') <#AEN1137>`__
2.3.16 `Alpha Processor Inc. UP1000 <#AEN1180>`__
2.3.17 `Alpha Processor Inc. UP1100 <#AEN1229>`__
2.3.18 `Alpha Processor Inc. CS20, Compaq DS20L <#AEN1277>`__
2.4 `Supported Hardware Overview <#AEN1324>`__
2.5 `Acknowledgments <#AEN1356>`__
3 `Supported Devices <#SUPPORT>`__
3.1 `Disk Controllers <#AEN1403>`__
3.2 `Ethernet Interfaces <#ETHERNET>`__
3.3 `FDDI Interfaces <#AEN2897>`__
3.4 `ATM Interfaces <#AEN2907>`__
3.5 `Wireless Network Interfaces <#AEN2949>`__
3.6 `Miscellaneous Networks <#AEN3077>`__
3.7 `ISDN Interfaces <#AEN3098>`__
3.8 `Serial Interfaces <#AEN3162>`__
3.9 `Audio Devices <#AEN3322>`__
3.10 `Camera and Video Capture Devices <#AEN3448>`__
3.11 `USB Devices <#USB>`__
3.12 `IEEE 1394 (Firewire) Devices <#FIREWIRE>`__
3.13 `Bluetooth Devices <#BLUETOOTH>`__
3.14 `Cryptographic Accelerators <#AEN3747>`__
3.15 `Miscellaneous <#AEN3772>`__
...
5.0-RELEASE on the Alpha/AXP hardware platform (also referred to as
FreeBSD/alpha 5.0-RELEASE). It lists devices known to work on this
...
`pcm(4) <http://www.FreeBSD.org/cgi/man.cgi?query=pcm&sektion=4&manpath=FreeBSD+5.0-RELEASE>`__
...
.. raw:: html
    ...
    **Note:** Contrary to expectation there is no ``cpu EV6`` defined
    ...
    mandatory to keep
    `config(8) <http://www.FreeBSD.org/cgi/man.cgi?query=config&sektion=8&manpath=FreeBSD+5.0-RELEASE>`__
    happy.
...
`de(4) <http://www.FreeBSD.org/cgi/man.cgi?query=de&sektion=4&manpath=FreeBSD+5.0-RELEASE>`__
(older driver) or
...
-  Adaptec
   ...
   variants
   (`ahc(4) <http://www.FreeBSD.org/cgi/man.cgi?query=ahc&sektion=4&manpath=FreeBSD+5.0-RELEASE>`__
   driver)
...
(`amr(4) <http://www.FreeBSD.org/cgi/man.cgi?query=amr&sektion=4&manpath=FreeBSD+5.0-RELEASE>`__
driver)
...
firmware
(`mlx(4) <http://www.FreeBSD.org/cgi/man.cgi?query=mlx&sektion=4&manpath=FreeBSD+5.0-RELEASE>`__
driver)
...
(`ncr(4) <http://www.FreeBSD.org/cgi/man.cgi?query=ncr&sektion=4&manpath=FreeBSD+5.0-RELEASE>`__
and
`sym(4) <http://www.FreeBSD.org/cgi/man.cgi?query=sym&sektion=4&manpath=FreeBSD+5.0-RELEASE>`__
drivers)
...
(`sf(4) <http://www.FreeBSD.org/cgi/man.cgi?query=sf&sektion=4&manpath=FreeBSD+5.0-RELEASE>`__
driver)
...
AMD PCnet NICs
(`lnc(4) <http://www.FreeBSD.org/cgi/man.cgi?query=lnc&sektion=4&manpath=FreeBSD+5.0-RELEASE>`__
and
`pcn(4) <http://www.FreeBSD.org/cgi/man.cgi?query=pcn&sektion=4&manpath=FreeBSD+5.0-RELEASE>`__
drivers)
...
(`rl(4) <http://www.FreeBSD.org/cgi/man.cgi?query=rl&sektion=4&manpath=FreeBSD+5.0-RELEASE>`__
driver)
...
(`wb(4) <http://www.FreeBSD.org/cgi/man.cgi?query=wb&sektion=4&manpath=FreeBSD+5.0-RELEASE>`__
driver)
...
Ethernet NICs
(`vr(4) <http://www.FreeBSD.org/cgi/man.cgi?query=vr&sektion=4&manpath=FreeBSD+5.0-RELEASE>`__
driver)
...
(`sis(4) <http://www.FreeBSD.org/cgi/man.cgi?query=sis&sektion=4&manpath=FreeBSD+5.0-RELEASE>`__
driver)
...
(`ste(4) <http://www.FreeBSD.org/cgi/man.cgi?query=ste&sektion=4&manpath=FreeBSD+5.0-RELEASE>`__
driver)

-  D-Link DFE-550TX

SysKonnect SK-984x PCI Gigabit Ethernet cards
(`sk(4) <http://www.FreeBSD.org/cgi/man.cgi?query=sk&sektion=4&manpath=FreeBSD+5.0-RELEASE>`__
drivers)
...
(`tl(4) <http://www.FreeBSD.org/cgi/man.cgi?query=tl&sektion=4&manpath=FreeBSD+5.0-RELEASE>`__
driver)
...
(`xl(4) <http://www.FreeBSD.org/cgi/man.cgi?query=xl&sektion=4&manpath=FreeBSD+5.0-RELEASE>`__
driver)
...
(3CR990) chipset
(`txp(4) <http://www.FreeBSD.org/cgi/man.cgi?query=txp&sektion=4&manpath=FreeBSD+5.0-RELEASE>`__
driver)
...
DEC DEFPA PCI
(`fpa(4) <http://www.FreeBSD.org/cgi/man.cgi?query=fpa&sektion=4&manpath=FreeBSD+5.0-RELEASE>`__
driver)
...
(`rp(4) <http://www.FreeBSD.org/cgi/man.cgi?query=rp&sektion=4&manpath=FreeBSD+5.0-RELEASE>`__
driver)
...
-  ES1868, ES1869, ES1879 and ES1888
   (`sbc(4) <http://www.FreeBSD.org/cgi/man.cgi?query=sbc&sektion=4&manpath=FreeBSD+5.0-RELEASE>`__
   driver)
...
Host Controllers
(`ohci(4) <http://www.FreeBSD.org/cgi/man.cgi?query=ohci&sektion=4&manpath=FreeBSD+5.0-RELEASE>`__
and
`uhci(4) <http://www.FreeBSD.org/cgi/man.cgi?query=uhci&sektion=4&manpath=FreeBSD+5.0-RELEASE>`__
drivers)
...
Keyboards
(`ukbd(4) <http://www.FreeBSD.org/cgi/man.cgi?query=ukbd&sektion=4&manpath=FreeBSD+5.0-RELEASE>`__
driver)
...
Mice
(`ums(4) <http://www.FreeBSD.org/cgi/man.cgi?query=ums&sektion=4&manpath=FreeBSD+5.0-RELEASE>`__
driver)
...
(`ulpt(4) <http://www.FreeBSD.org/cgi/man.cgi?query=ulpt&sektion=4&manpath=FreeBSD+5.0-RELEASE>`__
driver)
...
Storage
(`umass(4) <http://www.FreeBSD.org/cgi/man.cgi?query=umass&sektion=4&manpath=FreeBSD+5.0-RELEASE>`__
driver)
...
Floppy drives
(`fd(4) <http://www.FreeBSD.org/cgi/man.cgi?query=fd&sektion=4&manpath=FreeBSD+5.0-RELEASE>`__
driver)
...
(`ppc(4) <http://www.FreeBSD.org/cgi/man.cgi?query=ppc&sektion=4&manpath=FreeBSD+5.0-RELEASE>`__
driver)
