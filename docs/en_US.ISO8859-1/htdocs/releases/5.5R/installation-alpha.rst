===================================================
FreeBSD/alpha 5.5-RELEASE Installation Instructions
===================================================
...
.. raw:: html
    ...
    FreeBSD/alpha 5.5-RELEASE, with particular emphasis given to
...
prompt (``>>>``), just insert the ``boot.flp`` floppy and type the
