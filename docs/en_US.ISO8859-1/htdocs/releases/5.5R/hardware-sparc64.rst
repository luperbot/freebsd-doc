==========================================
FreeBSD/sparc64 5.5-RELEASE Hardware Notes
==========================================
...
2.2 `Partially Supported Systems <#AEN82>`__
2.3 `Unsupported Systems <#AEN90>`__
...
5.5-RELEASE on the UltraSPARC hardware platform (also referred to as
FreeBSD/sparc64 5.5-RELEASE). It lists devices known to work on this
...
tested with FreeBSD 5.5-RELEASE. We encourage you to try it and send a
...
Cards supported by
`gem(4) <http://www.FreeBSD.org/cgi/man.cgi?query=gem&sektion=4&manpath=FreeBSD+5.5-RELEASE>`__
driver include:
...
(`sab(4) <http://www.FreeBSD.org/cgi/man.cgi?query=sab&sektion=4&manpath=FreeBSD+5.5-RELEASE>`__
driver)
...
The
`snd\_audiocs(4) <http://www.FreeBSD.org/cgi/man.cgi?query=snd_audiocs&sektion=4&manpath=FreeBSD+5.5-RELEASE>`__
