=========================================
FreeBSD/sparc64 5.4-RELEASE Release Notes
=========================================
...
The
`auxio(4) <http://www.FreeBSD.org/cgi/man.cgi?query=auxio&sektion=4&manpath=FreeBSD+5.4-RELEASE>`__
driver has been to drive some auxiliary I/O functions found on various
SBus/EBus UltraSPARC® models.
...
found on some UltraSPARC II and III models.

The
`uart(4) <http://www.FreeBSD.org/cgi/man.cgi?query=uart&sektion=4&manpath=FreeBSD+5.4-RELEASE>`__
driver is now enabled in the ``GENERIC`` kernel, and is now the default
driver for serial ports. The ofw\_console,
`sab(4) <http://www.FreeBSD.org/cgi/man.cgi?query=sab&sektion=4&manpath=FreeBSD+5.4-RELEASE>`__,
and zs drivers are now disabled in the ``GENERIC`` kernel.
...
The
`snd\_audiocs(4) <http://www.FreeBSD.org/cgi/man.cgi?query=snd_audiocs&sektion=4&manpath=FreeBSD+5.4-RELEASE>`__
driver has been added to support the Crystal Semiconductor CS4231 audio
controller found on UltraSPARC workstations.
...
Project <http://www.FreeBSD.org/gnome/>`__ Web page.
