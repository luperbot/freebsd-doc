...
2.3.2 `Universal Desktop Box (UDB or \`\`Multia'') <#AEN185>`__
2.3.3 `Personal Workstation (\`\`Miata'') <#AEN274>`__
2.3.4 `Evaluation Board 64 family <#AEN384>`__
...
\`\`Bret'' for EV56) <#AEN575>`__
2.3.8 `AlphaServer 1000 (\`\`Mikasa''), 1000A (\`\`Noritake'') and
800(\`\`Corelle'') <#AEN687>`__
2.3.9 `DS10/VS10/XP900 (\`\`Webbrick'') / XP1000 (\`\`Monet'') / DS10L
(\`\`Slate'') <#AEN743>`__
2.3.10 `DS20/DS20E (\`\`Goldrush'') <#AEN894>`__
2.3.11 `AlphaPC 264DP / UP2000 <#AEN963>`__
2.3.12 `AlphaServer 2000 (\`\`DemiSable''), 2100 (\`\`Sable''), 2100A
(\`\`Lynx'') <#AEN1009>`__
2.3.13 `AlphaServer 4x00 (\`\`Rawhide'') <#AEN1080>`__
2.3.14 `AlphaServer 1200 (\`\`Tincup'') and AlphaStation 1200
(\`\`DaVinci'') <#AEN1113>`__
2.3.15 `AlphaServer 8200 and 8400 (\`\`TurboLaser'') <#AEN1143>`__
2.3.16 `Alpha Processor Inc. UP1000 <#AEN1186>`__
2.3.17 `Alpha Processor Inc. UP1100 <#AEN1235>`__
2.3.18 `Alpha Processor Inc. CS20, Compaq DS20L <#AEN1283>`__
2.3.19 `Compaq AlphaServer ES40 (\`\`Clipper'') <#AEN1330>`__
2.4 `Supported Hardware Overview <#AEN1367>`__
2.5 `Acknowledgments <#AEN1399>`__
...
5.4-RELEASE on the Alpha/AXP hardware platform (also referred to as
FreeBSD/alpha 5.4-RELEASE). It lists devices known to work on this
