==============================
Testing Guide for 4.10-RELEASE
==============================
...
listed the changes in 4.10-RELEASE that we feel merit the most attention
...
-  There was a large merge of the USB code from RELENG\_5 into
   RELENG\_4. This requires as much testing as possible to make sure
   that no devices have regressed in stability or functionality.
