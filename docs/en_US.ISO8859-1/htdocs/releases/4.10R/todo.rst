...
This is a list of open issues that need to be resolved for FreeBSD 4.10.
...
+------------------------------+-----------------+---------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| vmspace leak                 | Needs?testing   | --            | Copying vm\_exitingcnt to the new vmspace in vmspace\_exec() can make it very high values and never drop to 0 and be freed. This can cause a system crash. A patch for the problem has been committed just before 4.10-RC3.                                                                                                  |
+------------------------------+-----------------+---------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
