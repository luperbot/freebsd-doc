==========================================
FreeBSD/alpha 4.6.2-RELEASE Hardware Notes
==========================================
...
**Table of Contents**
1 `Introduction <#AEN10>`__
2 `Supported processors and motherboards <#AEN15>`__
2.1 `Overview <#AEN24>`__
2.2 `In general, what do you need to run FreeBSD on an
Alpha? <#AEN43>`__
2.3 `System-specific information <#AEN104>`__
2.3.1 `AXPpci33 (\`\`NoName'') <#AEN109>`__
2.3.2 `Universal Desktop Box (UDB or \`\`Multia'') <#AEN183>`__
2.3.3 `Personal Workstation (\`\`Miata'') <#AEN269>`__
...
\`\`Bret'' for EV56) <#AEN732>`__
2.3.9 `AlphaServer 1000 (\`\`Mikasa''), 1000A (\`\`Noritake'') and
800(\`\`Corelle'') <#AEN842>`__
2.3.10 `DS10/VS10/XP900 (\`\`Webbrick'') / XP1000 (\`\`Monet'') / DS10L
(\`\`Slate'') <#AEN898>`__
2.3.11 `DS20/DS20E (\`\`Goldrush'') <#AEN1049>`__
2.3.12 `AlphaPC 264DP / UP2000 <#AEN1118>`__
2.3.13 `AlphaServer 2000 (\`\`DemiSable''), 2100 (\`\`Sable''), 2100A
(\`\`Lynx'') <#AEN1164>`__
2.3.14 `AlphaServer 4x00 (\`\`Rawhide'') <#AEN1235>`__
2.3.15 `AlphaServer 1200 (\`\`Tincup'') and AlphaStation 1200
(\`\`DaVinci'') <#AEN1266>`__
2.3.16 `AlphaServer 8200 and 8400 (\`\`TurboLaser'') <#AEN1296>`__
2.3.17 `Alpha Processor Inc. UP1000 <#AEN1339>`__
2.3.18 `Alpha Processor Inc. UP1100 <#AEN1388>`__
2.3.19 `Alpha Processor Inc. CS20, Compaq DS20L <#AEN1436>`__
2.4 `Supported Hardware Overview <#AEN1483>`__
2.5 `Acknowledgments <#AEN1515>`__
3 `Supported Devices <#AEN1556>`__
3.1 `Disk Controllers <#AEN1562>`__
3.2 `Ethernet Interfaces <#ETHERNET>`__
3.3 `FDDI Interfaces <#AEN2792>`__
3.4 `ATM Interfaces <#AEN2802>`__
3.5 `Wireless Network Interfaces <#AEN2844>`__
3.6 `Miscellaneous Networks <#AEN2969>`__
3.7 `ISDN Interfaces <#AEN2979>`__
3.8 `Multi-port Serial Interfaces <#AEN3043>`__
3.9 `Audio Devices <#AEN3140>`__
3.10 `Camera and Video Capture Devices <#AEN3242>`__
3.11 `USB Devices <#USB>`__
3.12 `Miscellaneous <#AEN3424>`__
...
4.6.2-RELEASE on the Alpha/AXP hardware platform (also referred to as
FreeBSD/alpha 4.6.2-RELEASE). It lists devices known to work on this
...
`pcm(4) <http://www.FreeBSD.org/cgi/man.cgi?query=pcm&sektion=4&manpath=FreeBSD+4.6-RELEASE>`__
...
\`\`before'' the bridge, in one of the 64 bit PCI slots.
...
.. raw:: html
    ...
    **Note:** Contrary to expectation there is no ``cpu EV6`` defined
    ...
    mandatory to keep
    `config(8) <http://www.FreeBSD.org/cgi/man.cgi?query=config&sektion=8&manpath=FreeBSD+4.6-RELEASE>`__
    happy.
...
bit (16 Mbyte). Each memory board can house 4 banks of SIMMs. SIMM sizes
can not be mixed on a single memory board. The first memory module must
be filled with SIMMs before starting to fill the next memory module.
Note that the spacing between the slots is not that big, so make sure
your SIMMs fit physically (before buying them..)
...
`ata(4) <http://www.FreeBSD.org/cgi/man.cgi?query=ata&sektion=4&manpath=FreeBSD+4.6-RELEASE>`__
...
`de(4) <http://www.FreeBSD.org/cgi/man.cgi?query=de&sektion=4&manpath=FreeBSD+4.6-RELEASE>`__
(older driver) or
`dc(4) <http://www.FreeBSD.org/cgi/man.cgi?query=dc&sektion=4&manpath=FreeBSD+4.6-RELEASE>`__
(newer driver). Some new SRM versions are known to recognize the Intel
8255x Ethernet chips as driven by the FreeBSD
`fxp(4) <http://www.FreeBSD.org/cgi/man.cgi?query=fxp&sektion=4&manpath=FreeBSD+4.6-RELEASE>`__
...
-  Adaptec
   ...
   variants
   (`ahc(4) <http://www.FreeBSD.org/cgi/man.cgi?query=ahc&sektion=4&manpath=FreeBSD+4.6-RELEASE>`__
   driver)
...
(`amr(4) <http://www.FreeBSD.org/cgi/man.cgi?query=amr&sektion=4&manpath=FreeBSD+4.6-RELEASE>`__
driver)
...
firmware
(`mlx(4) <http://www.FreeBSD.org/cgi/man.cgi?query=mlx&sektion=4&manpath=FreeBSD+4.6-RELEASE>`__
driver)
...
(`ncr(4) <http://www.FreeBSD.org/cgi/man.cgi?query=ncr&sektion=4&manpath=FreeBSD+4.6-RELEASE>`__
and
`sym(4) <http://www.FreeBSD.org/cgi/man.cgi?query=sym&sektion=4&manpath=FreeBSD+4.6-RELEASE>`__
drivers)
...
(`isp(4) <http://www.FreeBSD.org/cgi/man.cgi?query=isp&sektion=4&manpath=FreeBSD+4.6-RELEASE>`__
driver)
...
`cd(4) <http://www.FreeBSD.org/cgi/man.cgi?query=cd&sektion=4&manpath=FreeBSD+4.6-RELEASE>`__).
WORM/CD-R/CD-RW writing support is provided by
`cdrecord(1) <http://www.FreeBSD.org/cgi/man.cgi?query=cdrecord&sektion=1&manpath=FreeBSD+4.6-RELEASE>`__,
...
-  ATAPI IDE interface
   (`acd(4) <http://www.FreeBSD.org/cgi/man.cgi?query=acd&sektion=4&manpath=FreeBSD+4.6-RELEASE>`__)
...
(`sf(4) <http://www.FreeBSD.org/cgi/man.cgi?query=sf&sektion=4&manpath=FreeBSD+4.6-RELEASE>`__
driver)
...
AMD PCnet NICs
(`lnc(4) <http://www.FreeBSD.org/cgi/man.cgi?query=lnc&sektion=4&manpath=FreeBSD+4.6-RELEASE>`__
and
`pcn(4) <http://www.FreeBSD.org/cgi/man.cgi?query=pcn&sektion=4&manpath=FreeBSD+4.6-RELEASE>`__
drivers)
...
NE2000 and clones
(`ed(4) <http://www.FreeBSD.org/cgi/man.cgi?query=ed&sektion=4&manpath=FreeBSD+4.6-RELEASE>`__
driver)
...
(`rl(4) <http://www.FreeBSD.org/cgi/man.cgi?query=rl&sektion=4&manpath=FreeBSD+4.6-RELEASE>`__
driver)
...
(`wb(4) <http://www.FreeBSD.org/cgi/man.cgi?query=wb&sektion=4&manpath=FreeBSD+4.6-RELEASE>`__
driver)
...
Ethernet NICs
(`vr(4) <http://www.FreeBSD.org/cgi/man.cgi?query=vr&sektion=4&manpath=FreeBSD+4.6-RELEASE>`__
driver)
...
(`sis(4) <http://www.FreeBSD.org/cgi/man.cgi?query=sis&sektion=4&manpath=FreeBSD+4.6-RELEASE>`__
driver)
...
(`ste(4) <http://www.FreeBSD.org/cgi/man.cgi?query=ste&sektion=4&manpath=FreeBSD+4.6-RELEASE>`__
driver)

-  D-Link DFE-550TX

SysKonnect SK-984x PCI Gigabit Ethernet cards
(`sk(4) <http://www.FreeBSD.org/cgi/man.cgi?query=sk&sektion=4&manpath=FreeBSD+4.6-RELEASE>`__
drivers)
...
(`tl(4) <http://www.FreeBSD.org/cgi/man.cgi?query=tl&sektion=4&manpath=FreeBSD+4.6-RELEASE>`__
driver)
...
Davicom DM9100 and DM9102 PCI Fast Ethernet NICs
(`dc(4) <http://www.FreeBSD.org/cgi/man.cgi?query=dc&sektion=4&manpath=FreeBSD+4.6-RELEASE>`__
driver)
...
(`xl(4) <http://www.FreeBSD.org/cgi/man.cgi?query=xl&sektion=4&manpath=FreeBSD+4.6-RELEASE>`__
driver)
...
(3CR990) chipset
(`txp(4) <http://www.FreeBSD.org/cgi/man.cgi?query=txp&sektion=4&manpath=FreeBSD+4.6-RELEASE>`__
driver)
...
chips
(`wx(4) <http://www.FreeBSD.org/cgi/man.cgi?query=wx&sektion=4&manpath=FreeBSD+4.6-RELEASE>`__,
`gx(4) <http://www.FreeBSD.org/cgi/man.cgi?query=gx&sektion=4&manpath=FreeBSD+4.6-RELEASE>`__
and
`em(4) <http://www.FreeBSD.org/cgi/man.cgi?query=em&sektion=4&manpath=FreeBSD+4.6-RELEASE>`__
drivers), plus NICs supported by the Intel 82540EM and 82544 controller
chips
(`em(4) <http://www.FreeBSD.org/cgi/man.cgi?query=em&sektion=4&manpath=FreeBSD+4.6-RELEASE>`__
driver only)
...
DEC DEFPA PCI
(`fpa(4) <http://www.FreeBSD.org/cgi/man.cgi?query=fpa&sektion=4&manpath=FreeBSD+4.6-RELEASE>`__
driver)
...
-  ES1868, ES1869, ES1879 and ES1888
   (`sbc(4) <http://www.FreeBSD.org/cgi/man.cgi?query=sbc&sektion=4&manpath=FreeBSD+4.6-RELEASE>`__
   driver)
...
Host Controllers
(`ohci(4) <http://www.FreeBSD.org/cgi/man.cgi?query=ohci&sektion=4&manpath=FreeBSD+4.6-RELEASE>`__
and
`uhci(4) <http://www.FreeBSD.org/cgi/man.cgi?query=uhci&sektion=4&manpath=FreeBSD+4.6-RELEASE>`__
drivers)
...
Keyboards
(`ukbd(4) <http://www.FreeBSD.org/cgi/man.cgi?query=ukbd&sektion=4&manpath=FreeBSD+4.6-RELEASE>`__
driver)
...
Mice
(`ums(4) <http://www.FreeBSD.org/cgi/man.cgi?query=ums&sektion=4&manpath=FreeBSD+4.6-RELEASE>`__
driver)
...
(`ulpt(4) <http://www.FreeBSD.org/cgi/man.cgi?query=ulpt&sektion=4&manpath=FreeBSD+4.6-RELEASE>`__
driver)
...
Storage
(`umass(4) <http://www.FreeBSD.org/cgi/man.cgi?query=umass&sektion=4&manpath=FreeBSD+4.6-RELEASE>`__
driver)
...
Floppy drives
(`fd(4) <http://www.FreeBSD.org/cgi/man.cgi?query=fd&sektion=4&manpath=FreeBSD+4.6-RELEASE>`__
driver)
...
-  PS/2 mice
   (`psm(4) <http://www.FreeBSD.org/cgi/man.cgi?query=psm&sektion=4&manpath=FreeBSD+4.6-RELEASE>`__
   driver)
...
(`ppc(4) <http://www.FreeBSD.org/cgi/man.cgi?query=ppc&sektion=4&manpath=FreeBSD+4.6-RELEASE>`__
driver)

\`\`PC standard'' 8250, 16450, and 16550-based serial ports
(`sio(4) <http://www.FreeBSD.org/cgi/man.cgi?query=sio&sektion=4&manpath=FreeBSD+4.6-RELEASE>`__
driver)
