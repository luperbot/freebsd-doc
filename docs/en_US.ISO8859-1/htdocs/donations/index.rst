...
`FreeBSD?Foundation <http://www.freebsdfoundation.org/donate/>`__
donation page.
...
-  `FreeBSD Project Want
   List <https://wiki.freebsd.org/Donations/WantList>`__
-  `List of FreeBSD Donations <donors.html>`__
...
needs <https://wiki.freebsd.org/Donations/WantList>`__. We would
...
`Hardware Donation
Form <http://www.freebsdfoundation.org/documents/Hardware%20Donation%20Form.pdf>`__
...
Foundation <http://www.freebsdfoundation.org>`__, accepts financial
