...
`2. A look inside… <#inside>`__
`3. Emulation <#freebsd-emulation>`__
`4. Linux? emulation layer -MD part <#md>`__
`5. Linux? emulation layer -MI part <#mi>`__
`6. Conclusion <#conclusion>`__
`7. Literatures <#literatures>`__
