...
„Unterteilung“`:sup:`[3]` <#ftn.idp64990544>`__ des Inhalts vorstellen.
...
#. Anschlie?end muss in den Shellkonfigurationsdateien die Variable
   ``SGML_CATALOG_FILES`` `:sup:`[4]` <#ftn.idp65091280>`__ gesetzt
   werden.
...
#. Jetzt sollten die Tags ``title`` und ``/title`` aus dem Dokument
   ...
   ``E`` f?r Fehler`:sup:`[a]` <#ftn.idp67523408>`__ und ``X`` f?r einen
   ...
   .. raw:: html
      ...
      <div id="ftn.idp67523408" class="footnote">

   `:sup:`[a]` <#idp67523408>`__\ Nicht immer besteht eine Meldung aus
...
.. raw:: html
   ...
   <div id="ftn.idp64990544" class="footnote">

`:sup:`[3]` <#idp64990544>`__\ Im angels?chsischen Sprachraum wird hier
...
.. raw:: html
   ...
   <div id="ftn.idp65091280" class="footnote">

`:sup:`[4]` <#idp65091280>`__\ Sofern man nicht an der deutschen
