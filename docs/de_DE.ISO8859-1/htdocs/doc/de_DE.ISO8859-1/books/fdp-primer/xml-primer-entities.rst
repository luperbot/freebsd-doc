...
``&entitaetenname;`` referenziert`:sup:`[6]` <#ftn.idp67714896>`__.
...
#. ?ffnen Sie nun ``beispiel.xml`` mit Ihrem Webbrowser. Es kann
   ...
   k?nnen`:sup:`[7]` <#ftn.idp67736528>`__.
...
.. raw:: html
   ...
   <div id="ftn.idp67714896" class="footnote">

`:sup:`[6]` <#idp67714896>`__\ Es wird das Prozentzeichen anstelle des
...
.. raw:: html
   ...
   <div id="ftn.idp67736528" class="footnote">

`:sup:`[7]` <#idp67736528>`__\ Eigentlich ist das eine Schande. Man
