...
``maxproc``
    ...
    `:sup:`[8]` <#ftn.idp77916496>`__ zu verwenden. Ein paar Aufgaben,
...
``openfiles``
    ...
    `:sup:`[9]` <#ftn.idp77940176>`__ darzustellen. Setzen Sie es
...
.. raw:: html
   ...
   <div id="ftn.idp77916496" class="footnote">

`:sup:`[8]` <#idp77916496>`__\ *Pipeline* = *Leitung*. Mit *Pipes* sind
...
.. raw:: html
   ...
   <div id="ftn.idp77940176" class="footnote">

`:sup:`[9]` <#idp77940176>`__\ *IPC* steht f?r *Interprocess
Communication*.
