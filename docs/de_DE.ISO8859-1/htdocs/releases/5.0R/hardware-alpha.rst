...
2.1. `?bersicht <#AEN34>`__
2.2. `Was braucht man im Allgemeinen um FreeBSD auf einer Alpha zu
nutzen? <#AEN52>`__
2.3. `Spezifische Informationen f?r einzelne Systeme <#AEN114>`__
2.3.1. `AXPpci33 (\`\`NoName'') <#AEN119>`__
2.3.2. `Universal Desktop Box (UDB oder \`\`Multia'') <#AEN194>`__
2.3.3. `Personal Workstation (\`\`Miata'') <#AEN284>`__
2.3.4. `Evaluation Board 64 Systeme <#AEN393>`__
...
2.4. `?bersicht ?ber die unterst?tzte Hardware <#AEN1341>`__
2.5. `Danksagung <#AEN1373>`__
3. `Unterst?tzte Ger?te <#SUPPORT>`__
3.1. `Festplatten-Controller <#AEN1420>`__
3.2. `Netzwerkkarten <#ETHERNET>`__
3.3. `FDDI Karten <#AEN2912>`__
3.4. `ATM Karten <#AEN2922>`__
3.5. `Karten f?r drahtlose Netzwerke <#AEN2965>`__
3.6. `Diverse Netzwerkkarten <#AEN3093>`__
3.7. `ISDN Karten <#AEN3117>`__
3.8. `Serielle Schnittstellen <#AEN3181>`__
3.9. `Audio Hardware <#AEN3342>`__
3.10. `Kameras, TV-Karten, etc <#AEN3468>`__
3.11. `USB Ger?te <#USB>`__
3.12. `IEEE 1394 (Firewire) Ger?te <#FIREWIRE>`__
3.13. `Bluetooth Ger?te <#BLUETOOTH>`__
3.14. `Verschl?sselungs-Hardware <#AEN3767>`__
3.15. `Diverses <#AEN3792>`__
...
5.0-CURRENT auf Alpha/AXP Systemen (meistens einfach FreeBSD/alpha
...
`pcm(4) <http://www.FreeBSD.org/cgi/man.cgi?query=pcm&sektion=4&manpath=FreeBSD+5.0-current>`__-Treiber
