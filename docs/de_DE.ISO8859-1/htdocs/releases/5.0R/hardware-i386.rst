...
3.3. `FDDI Karten <#AEN1529>`__
3.4. `ATM Karten <#AEN1539>`__
3.5. `Karten f?r drahtlose Netzwerke <#AEN1582>`__
3.6. `Diverse Netzwerkkarten <#AEN1710>`__
3.7. `ISDN Karten <#AEN1734>`__
3.8. `Serielle Schnittstellen <#AEN1798>`__
3.9. `Audio Hardware <#AEN1959>`__
3.10. `Kameras, TV-Karten, etc <#AEN2085>`__
3.11. `USB Ger?te <#USB>`__
3.12. `IEEE 1394 (Firewire) Ger?te <#FIREWIRE>`__
3.13. `Bluetooth Ger?te <#BLUETOOTH>`__
3.14. `Verschl?sselungs-Hardware <#AEN2384>`__
3.15. `Diverses <#AEN2409>`__
...
5.0-CURRENT auf i386 Systemen (meistens einfach FreeBSD/i386 5.0-CURRENT
...
Archive der Mailingliste 'FreeBSD symmetric multiprocessing'
``<freebsd-smp@FreeBSD.org>`` kann hier weiterhelfen.
...
Mailingliste 'FreeBSD laptop computer' ``<freebsd-mobile@FreeBSD.org>``
weiterhelfen.
...
(`ida(4) <http://www.FreeBSD.org/cgi/man.cgi?query=ida&sektion=4&manpath=FreeBSD+5.0-current>`__
driver)
...
nutzen
(`ciss(4) <http://www.FreeBSD.org/cgi/man.cgi?query=ciss&sektion=4&manpath=FreeBSD+5.0-current>`__
Treiber)
...
`cam(4) <http://www.FreeBSD.org/cgi/man.cgi?query=cam&sektion=4&manpath=FreeBSD+5.0-current>`__-System
umgeschrieben:
...
(`sn(4) <http://www.FreeBSD.org/cgi/man.cgi?query=sn&sektion=4&manpath=FreeBSD+5.0-current>`__
Treiber)
