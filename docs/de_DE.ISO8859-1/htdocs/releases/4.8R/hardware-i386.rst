...
3.3. `FDDI Karten <#AEN1332>`__
3.4. `ATM Karten <#AEN1342>`__
3.5. `Karten f?r drahtlose Netzwerke <#AEN1385>`__
3.6. `Diverse Netzwerkkarten <#AEN1513>`__
3.7. `ISDN Karten <#AEN1523>`__
3.8. `Serielle Multi-Port Karten <#AEN1587>`__
3.9. `Audio Hardware <#AEN1687>`__
3.10. `Kameras, TV-Karten, etc <#AEN1790>`__
3.11. `USB Ger?te <#USB>`__
3.12. `IEEE 1394 (Firewire) Ger?te <#FIREWIRE>`__
3.13. `Verschl?sselungs-Hardware <#AEN2049>`__
3.14. `Diverses <#AEN2074>`__
...
4.8-RELEASE auf i386 Systemen (meistens einfach FreeBSD/i386 4.8-RELEASE
...
`cam(4) <http://www.FreeBSD.org/cgi/man.cgi?query=cam&sektion=4&manpath=FreeBSD+4.8-RELEASE>`__-System
umgeschrieben:
