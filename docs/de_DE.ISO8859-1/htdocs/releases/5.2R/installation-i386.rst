...
.. raw:: html
    ...
    FreeBSD/i386 5.2-RELEASE, dabei wird besonderen Wert auf den Bezug
...
Schwerpunkt liegt dabei auf dem Bezug der FreeBSD 5.2-RELEASE
...
release\ ``/floppies/drivers.flp`` von ftp://ftp.FreeBSD.org/ oder einem
...
Beachten Sie bitte, da? die zweite Partition aus der ersten \`\`klont'',
...
.. raw:: html
    ...
    **Wichtig:** Diese Anleitung geht davon aus, da? Sie das
    `sysinstall(8) <http://www.FreeBSD.org/cgi/man.cgi?query=sysinstall&sektion=8&manpath=FreeBSD+5.2-RELEASE>`__-Programm
    der *NEUEN* FreeBSD-Version zur Aktualisierung verwenden. Die
    Verwendung der falschen
    `sysinstall(8) <http://www.FreeBSD.org/cgi/man.cgi?query=sysinstall&sektion=8&manpath=FreeBSD+5.2-RELEASE>`__-Version
    ...
    `sysinstall(8) <http://www.FreeBSD.org/cgi/man.cgi?query=sysinstall&sektion=8&manpath=FreeBSD+5.2-RELEASE>`__-Programms
...
.. raw:: html
    ...
    **Warnung:** Sie sollten nicht versuchen, Ihr System mit der
    ...
    von FreeBSD 4-STABLE auf FreeBSD 5.2-RELEASE zu aktualisieren.
...
nicht neu starten (Abbruch mit der Meldung read error). <#Q4.2.16.>`__
