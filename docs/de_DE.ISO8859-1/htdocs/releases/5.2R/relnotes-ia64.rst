...
Die Bibliothek ``libkse`` ist jetzt der Standard f?r Threading auf
FreeBSD/ia64 Systemen.
...
F?r die Architekturen alpha, amd64 und ia64 werden keine
Installationsdisketten mehr erzeugt.
