...
2.3.3. `Personal Workstation (\`\`Miata'') <#AEN281>`__
2.3.4. `Evaluation Board 64 Systeme <#AEN390>`__
...
EV5, \`\`Bret'' f?r EV56) <#AEN577>`__
2.3.8. `AlphaServer 1000 (\`\`Mikasa''), 1000A (\`\`Noritake'') und 800
(\`\`Corelle'') <#AEN687>`__
2.3.9. `DS10/VS10/XP900 (\`\`Webbrick'') / XP1000 (\`\`Monet'') / DS10L
(\`\`Slate'') <#AEN746>`__
2.3.10. `DS20/DS20E (\`\`Goldrush'') <#AEN899>`__
2.3.11. `AlphaPC 264DP / UP2000 <#AEN969>`__
2.3.12. `AlphaServer 2000 (\`\`DemiSable''), 2100 (\`\`Sable''), 2100A
(\`\`Lynx'') <#AEN1015>`__
2.3.13. `AlphaServer 4x00 (\`\`Rawhide'') <#AEN1088>`__
2.3.14. `AlphaServer 1200 (\`\`Tincup'') und AlphaStation 1200
(\`\`DaVinci'') <#AEN1121>`__
2.3.15. `AlphaServer 8200 und 8400 (\`\`TurboLaser'') <#AEN1151>`__
2.3.16. `Alpha Processor Inc. UP1000 <#AEN1195>`__
2.3.17. `Alpha Processor Inc. UP1100 <#AEN1245>`__
2.3.18. `Alpha Processor Inc. CS20, Compaq DS20L <#AEN1293>`__
2.3.19. `Compaq AlphaServer ES40 (\`\`Clipper'') <#AEN1340>`__
2.4. `?bersicht ?ber die unterst?tzte Hardware <#AEN1377>`__
2.5. `Danksagung <#AEN1409>`__
3. `Unterst?tzte Ger?te <#SUPPORT>`__
3.1. `Festplatten-Controller <#AEN1458>`__
3.2. `Netzwerkkarten <#ETHERNET>`__
3.3. `FDDI Karten <#AEN2177>`__
3.4. `ATM Karten <#AEN2187>`__
3.5. `Karten f?r drahtlose Netzwerke <#AEN2206>`__
3.6. `Diverse Netzwerkkarten <#AEN2232>`__
3.7. `ISDN Karten <#AEN2255>`__
3.8. `Serielle Schnittstellen <#AEN2319>`__
3.9. `Audio Hardware <#AEN2492>`__
3.10. `Kameras, TV-Karten, etc <#AEN2614>`__
3.11. `USB Ger?te <#USB>`__
3.12. `IEEE 1394 (Firewire) Ger?te <#FIREWIRE>`__
3.13. `Bluetooth Ger?te <#BLUETOOTH>`__
3.14. `Verschl?sselungs-Hardware <#AEN2840>`__
3.15. `Diverses <#AEN2858>`__
...
5.2-RELEASE auf Alpha/AXP Systemen (meistens einfach FreeBSD/alpha
...
`pcm(4) <http://www.FreeBSD.org/cgi/man.cgi?query=pcm&sektion=4&manpath=FreeBSD+5.2-RELEASE>`__-Treiber
