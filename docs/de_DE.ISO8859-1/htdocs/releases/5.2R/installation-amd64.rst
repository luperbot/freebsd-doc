...
.. raw:: html
    ...
    FreeBSD/amd64 5.2-RELEASE, dabei wird besonderen Wert auf den Bezug
...
FreeBSD f?r AMD64 l?uft auf allen Systemen mit Athlon64, Athlon64-FX
oder Opteron Prozessoren.

Wenn Sie eine Maschine mit nVidia nForce3 Pro-150 haben, m?ssen Sie die
IO APIC im BIOS deaktivieren. Wenn diese Einstellung nicht zur Verf?gung
steht, werden Sie h?chstwahrscheinlich ACPI abschalten. Der Pro-150
Chipsatz ist fehlerhaft und wir haben noch keine M?glichkeit gefunden,
...
Die Installation von Diskette wird auf FreeBSD/amd64 Systemen nicht
unterst?tzt.
...
1.6. Fragen und Antworten f?r Benutzer von AMD64
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
