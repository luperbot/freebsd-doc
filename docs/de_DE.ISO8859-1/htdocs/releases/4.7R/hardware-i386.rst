...
3.3. `FDDI Karten <#AEN1295>`__
3.4. `ATM Karten <#AEN1305>`__
3.5. `Karten f?r drahtlose Netzwerke <#AEN1348>`__
3.6. `Diverse Netzwerkkarten <#AEN1473>`__
3.7. `ISDN Karten <#AEN1483>`__
3.8. `Serielle Multi-Port Karten <#AEN1547>`__
3.9. `Audio Hardware <#AEN1647>`__
3.10. `Kameras, TV-Karten, etc <#AEN1749>`__
3.11. `USB Ger?te <#USB>`__
3.12. `Diverses <#AEN1955>`__
...
4.7-RELEASE auf IA-32 Systemen (meistens einfach FreeBSD/i386
