...
2.3.4. `DEC3000 Familie (die \`\`Bird'' Maschinen) <#AEN386>`__
2.3.5. `Evaluation Board 64 Systeme <#AEN558>`__
...
(\`\`Slate'') <#AEN905>`__
2.3.11. `DS20/DS20E (\`\`Goldrush'') <#AEN1058>`__
2.3.12. `AlphaPC 264DP / UP2000 <#AEN1128>`__
2.3.13. `AlphaServer 2000 (\`\`DemiSable''), 2100 (\`\`Sable''), 2100A
(\`\`Lynx'') <#AEN1174>`__
2.3.14. `AlphaServer 4x00 (\`\`Rawhide'') <#AEN1247>`__
2.3.15. `AlphaServer 1200 (\`\`Tincup'') und AlphaStation 1200
(\`\`DaVinci'') <#AEN1278>`__
2.3.16. `AlphaServer 8200 und 8400 (\`\`TurboLaser'') <#AEN1308>`__
2.3.17. `Alpha Processor Inc. UP1000 <#AEN1352>`__
2.3.18. `Alpha Processor Inc. UP1100 <#AEN1402>`__
2.3.19. `Alpha Processor Inc. CS20, Compaq DS20L <#AEN1450>`__
2.4. `?bersicht ?ber die unterst?tzte Hardware <#AEN1497>`__
2.5. `Danksagung <#AEN1529>`__
3. `Unterst?tzte Ger?te <#AEN1570>`__
3.1. `Festplatten-Controller <#AEN1576>`__
3.2. `Netzwerkkarten <#ETHERNET>`__
3.3. `FDDI Karten <#AEN2836>`__
3.4. `ATM Karten <#AEN2846>`__
3.5. `Karten f?r drahtlose Netzwerke <#AEN2889>`__
3.6. `Diverse Netzwerkkarten <#AEN3014>`__
3.7. `ISDN Karten <#AEN3024>`__
3.8. `Serielle Multi-Port Karten <#AEN3088>`__
3.9. `Audio Hardware <#AEN3188>`__
3.10. `Kameras, TV-Karten, etc <#AEN3290>`__
3.11. `USB Ger?te <#USB>`__
3.12. `Diverses <#AEN3496>`__
...
4.7-RELEASE auf Alpha/AXP Systemen (meistens einfach FreeBSD/alpha
4.7-RELEASE genannt). Hier finden Sie zum einen alle die Ger?te, von
