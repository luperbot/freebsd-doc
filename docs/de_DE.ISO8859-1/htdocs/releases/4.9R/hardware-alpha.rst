...
2.1. `?bersicht <#AEN29>`__
2.2. `Was braucht man im Allgemeinen um FreeBSD auf einer Alpha zu
nutzen? <#AEN47>`__
2.3. `Spezifische Informationen f?r einzelne Systeme <#AEN109>`__
2.3.1. `AXPpci33 (\`\`NoName'') <#AEN114>`__
2.3.2. `Universal Desktop Box (UDB oder \`\`Multia'') <#AEN188>`__
2.3.3. `Personal Workstation (\`\`Miata'') <#AEN274>`__
2.3.4. `DEC3000 Familie (die \`\`Bird'' Maschinen) <#AEN383>`__
2.3.5. `Evaluation Board 64 Systeme <#AEN555>`__
...
EV5, \`\`Bret'' f?r EV56) <#AEN738>`__
2.3.9. `AlphaServer 1000 (\`\`Mikasa''), 1000A (\`\`Noritake'') und 800
(\`\`Corelle'') <#AEN847>`__
2.3.10. `DS10/VS10/XP900 (\`\`Webbrick'') / XP1000 (\`\`Monet'') / DS10L
(\`\`Slate'') <#AEN906>`__
2.3.11. `DS20/DS20E (\`\`Goldrush'') <#AEN1059>`__
2.3.12. `AlphaPC 264DP / UP2000 <#AEN1129>`__
2.3.13. `AlphaServer 2000 (\`\`DemiSable''), 2100 (\`\`Sable''), 2100A
(\`\`Lynx'') <#AEN1175>`__
2.3.14. `AlphaServer 4x00 (\`\`Rawhide'') <#AEN1248>`__
2.3.15. `AlphaServer 1200 (\`\`Tincup'') und AlphaStation 1200
(\`\`DaVinci'') <#AEN1281>`__
2.3.16. `AlphaServer 8200 und 8400 (\`\`TurboLaser'') <#AEN1311>`__
2.3.17. `Alpha Processor Inc. UP1000 <#AEN1355>`__
2.3.18. `Alpha Processor Inc. UP1100 <#AEN1405>`__
2.3.19. `Alpha Processor Inc. CS20, Compaq DS20L <#AEN1453>`__
2.3.20. `Compaq AlphaServer ES40 (\`\`Clipper'') <#AEN1500>`__
2.4. `?bersicht ?ber die unterst?tzte Hardware <#AEN1537>`__
2.5. `Danksagung <#AEN1569>`__
3. `Unterst?tzte Ger?te <#AEN1610>`__
3.1. `Festplatten-Controller <#AEN1616>`__
3.2. `Netzwerkkarten <#ETHERNET>`__
3.3. `FDDI Karten <#AEN2922>`__
3.4. `ATM Karten <#AEN2932>`__
3.5. `Karten f?r drahtlose Netzwerke <#AEN2975>`__
3.6. `Diverse Netzwerkkarten <#AEN3103>`__
3.7. `ISDN Karten <#AEN3120>`__
3.8. `Serielle Multi-Port Karten <#AEN3184>`__
3.9. `Audio Hardware <#AEN3316>`__
3.10. `Kameras, TV-Karten, etc <#AEN3419>`__
3.11. `USB Ger?te <#USB>`__
3.12. `IEEE 1394 (Firewire) Ger?te <#FIREWIRE>`__
3.13. `Verschl?sselungs-Hardware <#AEN3680>`__
3.14. `Diverses <#AEN3705>`__
...
4.9-RELEASE auf Alpha/AXP Systemen (meistens einfach FreeBSD/alpha
4.9-RELEASE genannt). Hier finden Sie zum einen alle die Ger?te, von
...
`pcm(4) <http://www.FreeBSD.org/cgi/man.cgi?query=pcm&sektion=4&manpath=FreeBSD+4.9-RELEASE>`__-Treiber
