...
3.1. `Festplatten-Controller <#AEN1456>`__
3.2. `Netzwerkkarten <#ETHERNET>`__
3.3. `FDDI Karten <#AEN3017>`__
3.4. `ATM Karten <#AEN3027>`__
3.5. `Karten f?r drahtlose Netzwerke <#AEN3072>`__
3.6. `Diverse Netzwerkkarten <#AEN3200>`__
3.7. `ISDN Karten <#AEN3231>`__
3.8. `Serielle Schnittstellen <#AEN3295>`__
3.9. `Audio Hardware <#AEN3490>`__
3.10. `Kameras, TV-Karten, etc <#AEN3613>`__
3.11. `USB Ger?te <#USB>`__
3.12. `IEEE 1394 (Firewire) Ger?te <#FIREWIRE>`__
3.13. `Bluetooth Ger?te <#BLUETOOTH>`__
3.14. `Verschl?sselungs-Hardware <#AEN3991>`__
3.15. `Diverses <#AEN4016>`__
...
5.1-RELEASE auf Alpha/AXP Systemen (meistens einfach FreeBSD/alpha
...
`pcm(4) <http://www.FreeBSD.org/cgi/man.cgi?query=pcm&sektion=4&manpath=FreeBSD+5.1-release>`__-Treiber
