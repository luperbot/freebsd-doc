...
3.1. `Festplatten-Controller <#AEN105>`__
3.2. `Netzwerkkarten <#ETHERNET>`__
3.3. `FDDI Karten <#AEN1666>`__
3.4. `ATM Karten <#AEN1676>`__
3.5. `Karten f?r drahtlose Netzwerke <#AEN1721>`__
3.6. `Diverse Netzwerkkarten <#AEN1849>`__
3.7. `ISDN Karten <#AEN1880>`__
3.8. `Serielle Schnittstellen <#AEN1944>`__
3.9. `Audio Hardware <#AEN2139>`__
3.10. `Kameras, TV-Karten, etc <#AEN2262>`__
3.11. `USB Ger?te <#USB>`__
3.12. `IEEE 1394 (Firewire) Ger?te <#FIREWIRE>`__
3.13. `Bluetooth Ger?te <#BLUETOOTH>`__
3.14. `Verschl?sselungs-Hardware <#AEN2640>`__
3.15. `Diverses <#AEN2665>`__
...
5.1-RELEASE auf UltraSPARC Systemen (meistens einfach FreeBSD/sparc64
...
k?nnte das daran liegen, da? es noch mit FreeBSD 5.1-RELEASE getestet
