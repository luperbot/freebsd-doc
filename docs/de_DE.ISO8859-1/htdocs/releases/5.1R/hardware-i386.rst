...
3.1. `Festplatten-Controller <#AEN68>`__
3.2. `Netzwerkkarten <#ETHERNET>`__
3.3. `FDDI Karten <#AEN1629>`__
3.4. `ATM Karten <#AEN1639>`__
3.5. `Karten f?r drahtlose Netzwerke <#AEN1684>`__
3.6. `Diverse Netzwerkkarten <#AEN1812>`__
3.7. `ISDN Karten <#AEN1843>`__
3.8. `Serielle Schnittstellen <#AEN1907>`__
3.9. `Audio Hardware <#AEN2102>`__
3.10. `Kameras, TV-Karten, etc <#AEN2225>`__
3.11. `USB Ger?te <#USB>`__
3.12. `IEEE 1394 (Firewire) Ger?te <#FIREWIRE>`__
3.13. `Bluetooth Ger?te <#BLUETOOTH>`__
3.14. `Verschl?sselungs-Hardware <#AEN2603>`__
3.15. `Diverses <#AEN2628>`__
...
5.1-RELEASE auf i386 Systemen (meistens einfach FreeBSD/i386 5.1-RELEASE
...
die Zeile ``options SMP`` angegeben ist, erkennt und aktiviert der
Kernel die zus?tzlichen logischen Prozessoren. Der Standard-Scheduler in
...
einfache Vorgehen zu schlechter Performance f?hren kann, werden die
logischen CPUs beim Systemstart standardm??ig deaktiviert. Sie k?nnen
mit der sysctl-Variable ``machdep.hlt_logical_cpus`` aktiviert werden.
Es ist au?erdem m?glich, jede CPU anzuhalten, die sich im Idle-Loop
befindet, dazu dient die sysctl-Variable ``machdep.hlt_cpus``. Weitere
...
angepa?ten Kernel die Option ``PAE`` angegeben wird. In diesem Fall wird
der Speicher oberhalb von 4 GByte erkannt und steht f?r die Nutzung
durch das System zur Verf?gung. Allerdings sind nicht alle Teile von
FreeBSD und alle Treiber kompatibel zu ``PAE``. Weitere Informationen
finden Sie in
...
`acpi(4) <http://www.FreeBSD.org/cgi/man.cgi?query=acpi&sektion=4&manpath=FreeBSD+5.1-release>`__
...
-  Adaptec 154x ISA SCSI Controller
   (`aha(4) <http://www.FreeBSD.org/cgi/man.cgi?query=aha&sektion=4&manpath=FreeBSD+5.1-release>`__
   Treiber)
...
-  Adaptec 174x EISA SCSI Controller im normalen und erweiterten Modus
   (`aha(4) <http://www.FreeBSD.org/cgi/man.cgi?query=aha&sektion=4&manpath=FreeBSD+5.1-release>`__
   und
   `ahb(4) <http://www.FreeBSD.org/cgi/man.cgi?query=ahb&sektion=4&manpath=FreeBSD+5.1-release>`__
   Treiber)
...
(`asr(4) <http://www.FreeBSD.org/cgi/man.cgi?query=asr&sektion=4&manpath=FreeBSD+5.1-release>`__
Treiber)
...
(`bt(4) <http://www.FreeBSD.org/cgi/man.cgi?query=bt&sektion=4&manpath=FreeBSD+5.1-release>`__
Treiber):
...
(`dpt(4) <http://www.FreeBSD.org/cgi/man.cgi?query=dpt&sektion=4&manpath=FreeBSD+5.1-release>`__
Treiber)
...
(`twe(4) <http://www.FreeBSD.org/cgi/man.cgi?query=twe&sektion=4&manpath=FreeBSD+5.1-release>`__
Treiber)
...
(`vpo(4) <http://www.FreeBSD.org/cgi/man.cgi?query=vpo&sektion=4&manpath=FreeBSD+5.1-release>`__
Treiber)
...
(`ida(4) <http://www.FreeBSD.org/cgi/man.cgi?query=ida&sektion=4&manpath=FreeBSD+5.1-release>`__
driver)
...
nutzen
(`ciss(4) <http://www.FreeBSD.org/cgi/man.cgi?query=ciss&sektion=4&manpath=FreeBSD+5.1-release>`__
Treiber)
...
(`pst(4) <http://www.FreeBSD.org/cgi/man.cgi?query=pst&sektion=4&manpath=FreeBSD+5.1-release>`__
Treiber)
...
(`trm(4) <http://www.FreeBSD.org/cgi/man.cgi?query=trm&sektion=4&manpath=FreeBSD+5.1-release>`__
Treiber)
...
-  Sony-eigener Anschlu? (alle Modelle)
   (`scd(4) <http://www.FreeBSD.org/cgi/man.cgi?query=scd&sektion=4&manpath=FreeBSD+5.1-release>`__)
...
`cam(4) <http://www.FreeBSD.org/cgi/man.cgi?query=cam&sektion=4&manpath=FreeBSD+5.1-release>`__-System
umgeschrieben:
...
-  Mitsumi-eigener CDROM-Anschlu? (alle Varianten)
   (`mcd(4) <http://www.FreeBSD.org/cgi/man.cgi?query=mcd&sektion=4&manpath=FreeBSD+5.1-release>`__)
...
(`rdp(4) <http://www.FreeBSD.org/cgi/man.cgi?query=rdp&sektion=4&manpath=FreeBSD+5.1-release>`__
Treiber)
...
(`le(4) <http://www.FreeBSD.org/cgi/man.cgi?query=le&sektion=4&manpath=FreeBSD+5.1-release>`__
Treiber)
...
(`ex(4) <http://www.FreeBSD.org/cgi/man.cgi?query=ex&sektion=4&manpath=FreeBSD+5.1-release>`__
Treiber)
...
(`ie(4) <http://www.FreeBSD.org/cgi/man.cgi?query=ie&sektion=4&manpath=FreeBSD+5.1-release>`__
Treiber)
...
(`el(4) <http://www.FreeBSD.org/cgi/man.cgi?query=el&sektion=4&manpath=FreeBSD+5.1-release>`__
Treiber)
...
(`cs(4) <http://www.FreeBSD.org/cgi/man.cgi?query=cs&sektion=4&manpath=FreeBSD+5.1-release>`__
Treiber)

-  IBM Etherjet ISA

Megahertz X-Jack Ethernet PC-Card CC-10BT
(`sn(4) <http://www.FreeBSD.org/cgi/man.cgi?query=sn&sektion=4&manpath=FreeBSD+5.1-release>`__
Treiber)

Netzwerkkarten mit Xircom X3201 (Cardbus), dazu geh?ren auch:
...
(`wl(4) <http://www.FreeBSD.org/cgi/man.cgi?query=wl&sektion=4&manpath=FreeBSD+5.1-release>`__
Treiber)
...
(`sbni(4) <http://www.FreeBSD.org/cgi/man.cgi?query=sbni&sektion=4&manpath=FreeBSD+5.1-release>`__
Treiber)
...
Controller
(`lmc(4) <http://www.FreeBSD.org/cgi/man.cgi?query=lmc&sektion=4&manpath=FreeBSD+5.1-release>`__
Treiber)
...
ARNET Karten
(`ar(4) <http://www.FreeBSD.org/cgi/man.cgi?query=ar&sektion=4&manpath=FreeBSD+5.1-release>`__
Treiber)
...
(`cy(4) <http://www.FreeBSD.org/cgi/man.cgi?query=cy&sektion=4&manpath=FreeBSD+5.1-release>`__
Treiber)

STB 4 Port Karte (bei Benutzung eines gemeinsamen IRQs)

Intelligente serielle Karten von DigiBoard
(`dgb(4) <http://www.FreeBSD.org/cgi/man.cgi?query=dgb&sektion=4&manpath=FreeBSD+5.1-release>`__
Treiber)
...
-  SDL Communications RISCom/N2 und N2pci high-speed sync serial boards
   (`sr(4) <http://www.FreeBSD.org/cgi/man.cgi?query=sr&sektion=4&manpath=FreeBSD+5.1-release>`__
   Treiber)

Serielle Multi-Port Karten von Stallion Technologies

-  EasyIO
   (`stl(4) <http://www.FreeBSD.org/cgi/man.cgi?query=stl&sektion=4&manpath=FreeBSD+5.1-release>`__
   Treiber)
...
-  EasyConnection 8/64
   (`stli(4) <http://www.FreeBSD.org/cgi/man.cgi?query=stli&sektion=4&manpath=FreeBSD+5.1-release>`__
   Treiber)
...
(`si(4) <http://www.FreeBSD.org/cgi/man.cgi?query=si&sektion=4&manpath=FreeBSD+5.1-release>`__
Treiber)
...
(`csa(4) <http://www.FreeBSD.org/cgi/man.cgi?query=csa&sektion=4&manpath=FreeBSD+5.1-release>`__
Treiber)
...
Gravis
(`gusc(4) <http://www.FreeBSD.org/cgi/man.cgi?query=gusc&sektion=4&manpath=FreeBSD+5.1-release>`__
Treiber)
...
(`meteor(4) <http://www.FreeBSD.org/cgi/man.cgi?query=meteor&sektion=4&manpath=FreeBSD+5.1-release>`__
Treiber)
