...
.. raw:: html
    ...
    Dieses Dokument enth?lt die Errata f?r FreeBSD 5.1-RELEASE, also
    ...
    Diese Errata f?r FreeBSD 5.1-RELEASE werden bis zum Erscheinen von
    FreeBSD 5.2-RELEASE weiter aktualisiert werden.
...
5.1-RELEASE. Bevor Sie diese Version installieren, sollten Sie auf jeden
