...
.. raw:: html
    ...
    FreeBSD/i386 5.1-RELEASE, dabei wird besonderen Wert auf den Bezug
...
``release``\ ``/floppies/drivers.flp`` von ftp://ftp.FreeBSD.org/ oder
...
UserConfig f?r den IRQ den Wert ``-1`` eingeben. Damit teilen Sie dem
Kernel mit, da? er die \`soft' Konfiguration benutzen soll.
