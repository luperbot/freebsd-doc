...
.. raw:: html
    ...
    FreeBSD/i386 4.6.2-RELEASE, dabei wird besonderen Wert auf den Bezug
...
den Dateien ``floppies/kern.flp`` and ``floppies/mfsroot.flp`` erzeugen,
...
anderen \`\`slices'' eingeblendet. Beispielweise k?nnte Ihr Laufwerk
