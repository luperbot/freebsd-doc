...
Der Treiber ``tga`` wurde aus ``GENERIC`` entfernt, da er Abst?rze
w?hrend des Systemstarts verursacht und daher ?berarbeitet werden mu?.
Verwenden Sie stattdessen die serielle Konsole oder eine normale
VGA-Karte.

Die Unterst?tzung f?r TurboLaser-Maschinen wurde aus ``GENERIC``
entfernt.
