...
standardm??ig auf amd64 Systemen erzeugt.

Die Kerneloption COMPAT\_LINUX32 gestattet es, 32-Bit Linux-Programme
auf amd64-Systemen auszuf?hren.
...
Der Treiber
`agp(4) <http://www.FreeBSD.org/cgi/man.cgi?query=agp&sektion=4&manpath=FreeBSD+5.3-RELEASE>`__
unterst?tzt nun die AMD64 Graphics Aperture Relocation Table (GART).
...
Es gibt jetzt eine erste Version von
`truss(1) <http://www.FreeBSD.org/cgi/man.cgi?query=truss&sektion=1&manpath=FreeBSD+5.3-RELEASE>`__
f?r FreeBSD/amd64.
