...
.. raw:: html
    ...
    FreeBSD/amd64 5.3-RELEASE, dabei wird besonderen Wert auf den Bezug
...
\ **4.2.2.** Mein System nutzt den nVidia nForce3 Pro-150 Chipsatz und
friert am Ende des Startvorgangs ein oder verliert pl?tzlich Interrupts.
...
****\ Es gibt Probleme mit der APIC dieses Chipsatz und/oder dem BIOS
des Systems. Diese sind bisher auf jedem solchen System aufgetreten, da?
wir zum Zeitpunkt der Ver?ffentlichung [von 5.2, der ?bersetzer] gesehen
haben. Eine M?glichkeit ist, wie oben beschrieben ACPI abzuschalten. Die
etwas weniger drastische Variante ist, den Hint
\`\`hint.apic.0.disabled'' zu aktivieren. Falls m?glich, sollten Sie im
BIOS die Unterst?tzung f?r die APIC abschalten. Diese Option steht
allerdings nicht auf allen Systemen zur Verf?gung.
