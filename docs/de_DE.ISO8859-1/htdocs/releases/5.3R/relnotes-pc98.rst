...
wurde ein Fehler bei der automatischen Auswahl der Schreibdichte
behoben.
...
funktionieren jetzt auf FreeBSD/pc98 Systemen.
...
**libdisk** nutzt jetzt die richtigen Werte f?r die FreeBSD PC98
Partitionen. Damit ist es im Partitions-Editor von
`sysinstall(8) <http://www.FreeBSD.org/cgi/man.cgi?query=sysinstall&sektion=8&manpath=FreeBSD+5.3-RELEASE>`__
m?glich, eine korrekte FreeBSD Partition zu erstellen, die die gesamte
Platte nutzt. [MERGED]
