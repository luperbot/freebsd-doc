...
3. `Unterst?tzte Ger?te <#AEN35>`__
3.1. `Festplatten-Controller <#AEN41>`__
3.2. `Netzwerkkarten <#ETHERNET>`__
3.3. `FDDI Karten <#AEN1347>`__
3.4. `ATM Karten <#AEN1357>`__
3.5. `Karten f?r drahtlose Netzwerke <#AEN1400>`__
3.6. `Diverse Netzwerkkarten <#AEN1528>`__
3.7. `ISDN Karten <#AEN1588>`__
3.8. `Serielle Multi-Port Karten <#AEN1652>`__
3.9. `Audio Hardware <#AEN1784>`__
3.10. `Kameras, TV-Karten, etc <#AEN1887>`__
3.11. `USB Ger?te <#USB>`__
3.12. `IEEE 1394 (Firewire) Ger?te <#FIREWIRE>`__
3.13. `Verschl?sselungs-Hardware <#AEN2148>`__
3.14. `Diverses <#AEN2173>`__
...
4.11-RELEASE auf i386 Systemen (meistens einfach FreeBSD/i386
...
`cam(4) <http://www.FreeBSD.org/cgi/man.cgi?query=cam&sektion=4&manpath=FreeBSD+4.11-RELEASE>`__-System
umgeschrieben:
...
Cronyx Tau synchrone serielle Schnittstellen f?r den ISA-Bus
...
Cronyx Tau-PCI synchrone serielle Schnittstellen f?r den PCI-Bus
(`cp(4) <http://www.FreeBSD.org/cgi/man.cgi?query=cp&sektion=4&manpath=FreeBSD+4.11-RELEASE>`__
Treiber)

-  Cronyx Tau-PCI (dual RS-232/V.35) und Cronyx Tau-PCI/R (dual RS-
   530(RS-449)/X.21)

-  Cronyx Tau-PCI-L (eine RS-232/V.35) und Cronyx Tau-PCI-L/R (dual RS-
   530(RS-449)/X.21)

-  Cronyx Tau-PCI/E1 (zwei fractional E1) und Cronyx Tau-PCI/G703 (zwei
   unframed E1)
