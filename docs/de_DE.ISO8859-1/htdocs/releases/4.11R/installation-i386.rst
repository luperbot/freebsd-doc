...
.. raw:: html
    ...
    FreeBSD/i386 4.11-RELEASE, dabei wird besonderen Wert auf den Bezug
...
Schwerpunkt liegt dabei auf dem Bezug der FreeBSD 4.11-RELEASE
...
release\ ``/floppies/mfsroot.flp`` von ftp://ftp.FreeBSD.org/ oder einem
...
.. raw:: html
    ...
    **Wichtig:** Diese Anleitung geht davon aus, da? Sie das
    `sysinstall(8) <http://www.FreeBSD.org/cgi/man.cgi?query=sysinstall&sektion=8&manpath=FreeBSD+4.11-RELEASE>`__-Programm
    der *NEUEN* FreeBSD-Version zur Aktualisierung verwenden. Die
    Verwendung der falschen
    `sysinstall(8) <http://www.FreeBSD.org/cgi/man.cgi?query=sysinstall&sektion=8&manpath=FreeBSD+4.11-RELEASE>`__-Version
    ...
    `sysinstall(8) <http://www.FreeBSD.org/cgi/man.cgi?query=sysinstall&sektion=8&manpath=FreeBSD+4.11-RELEASE>`__-Programms
...
nicht neu starten (Abbruch mit der Meldung read error). <#Q4.3.20.>`__
