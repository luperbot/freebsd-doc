...
.. raw:: html
    ...
    4.11-RELEASE. Es enth?lt einige Hinweise, wie Sie FreeBSD beziehen
...
4.11-RELEASE und repr?sentiert den aktuellen Zustand im
...
-  ``RELNOTES.TXT``: Die begleitenden Informationen zu dieser Release
   enthalten die Neuerungen in dieser Version von FreeBSD (4.11-RELEASE)
   und die ?nderungen seit der letzten Version (FreeBSD 4.10-RELEASE).
