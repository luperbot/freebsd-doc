...
**\ `es-aspell-1.11.2 <https://svnweb.FreeBSD.org/ports/head/textproc/es-aspell>`__**
    | Aspell Spanish dictionary
    | `Long
      description <https://svnweb.FreeBSD.org/ports/head/textproc/es-aspell/pkg-descr?revision=HEAD>`__
      \|
      `Changes <https://svnweb.FreeBSD.org/ports/head/textproc/es-aspell/?view=log>`__
      \| `Main Web Site <http://www.datsi.fi.upm.es/~coes/>`__
    ...
    | *Also listed in:*
      **`Textproc <textproc.html#es-aspell-1.11.2>`__**

**\ `es-calligra-l10n-2.7.5\_3 <https://svnweb.FreeBSD.org/ports/head/editors/calligra-l10n-es>`__**
    | Spanish messages and documentation for Calligra
    | `Long
      description <https://svnweb.FreeBSD.org/ports/head/editors/calligra-l10n-es/pkg-descr?revision=HEAD?revision=HEAD?revision=HEAD>`__
      \|
      `Changes <https://svnweb.FreeBSD.org/ports/head/editors/calligra-l10n-es/?view=log>`__
    ...
    | *Also listed in:*
      **`Editors <editors.html#es-calligra-l10n-2.7.5_3>`__**,
      `Kde <kde.html#es-calligra-l10n-2.7.5_3>`__

**\ `es-gimp-help-html-2.8.1\_1 <https://svnweb.FreeBSD.org/ports/head/misc/gimp-help-es>`__**
    | The GIMP User Manual in Spanish
    | `Long
      description <https://svnweb.FreeBSD.org/ports/head/misc/gimp-help-en/pkg-descr?revision=HEAD?revision=HEAD?revision=HEAD>`__
      \|
      `Changes <https://svnweb.FreeBSD.org/ports/head/misc/gimp-help-es/?view=log>`__
    ...
    | *Requires:* `docbook-1.5 <textproc.html#docbook-1.5>`__,
      ...
      `xmlcharent-0.3\_2 <textproc.html#xmlcharent-0.3_2>`__
    | *Also listed in:*
      **`Misc <misc.html#es-gimp-help-html-2.8.1_1>`__**,
      `Graphics <graphics.html#es-gimp-help-html-2.8.1_1>`__

**\ `es-hunspell-0.7 <https://svnweb.FreeBSD.org/ports/head/textproc/es-hunspell>`__**
    | Spanish hunspell dictionaries
    | `Long
      description <https://svnweb.FreeBSD.org/ports/head/textproc/es-hunspell/pkg-descr?revision=HEAD>`__
      \|
      `Changes <https://svnweb.FreeBSD.org/ports/head/textproc/es-hunspell/?view=log>`__
      \| `Main Web
      Site <http://extensions.openoffice.org/en/project/es_ANY-dicts>`__
    | *Maintained by:* office@FreeBSD.org
    | *Also listed in:* **`Textproc <textproc.html#es-hunspell-0.7>`__**

**\ `es-hyphen-2013.09.01 <https://svnweb.FreeBSD.org/ports/head/textproc/es-hyphen>`__**
    | Spanish hyphenation rules
    | `Long
      description <https://svnweb.FreeBSD.org/ports/head/textproc/es-hyphen/pkg-descr?revision=HEAD>`__
      \|
      `Changes <https://svnweb.FreeBSD.org/ports/head/textproc/es-hyphen/?view=log>`__
      \| `Main Web
      Site <http://extensions.openoffice.org/en/project/es_ANY-dicts>`__
    | *Maintained by:* office@FreeBSD.org
    | *Also listed in:*
      **`Textproc <textproc.html#es-hyphen-2013.09.01>`__**

**\ `es-kde-l10n-4.14.3 <https://svnweb.FreeBSD.org/ports/head/misc/kde4-l10n-es>`__**
    | Spanish messages and documentation for KDE SC 4
    | `Long
      description <https://svnweb.FreeBSD.org/ports/head/misc/kde4-l10n-es/pkg-descr?revision=HEAD?revision=HEAD?revision=HEAD>`__
      \|
      `Changes <https://svnweb.FreeBSD.org/ports/head/misc/kde4-l10n-es/?view=log>`__
    ...
    | *Requires:* `OpenEXR-2.2.0\_5 <graphics.html#OpenEXR-2.2.0_5>`__,
      ...
      `xvid-1.3.2,1 <multimedia.html#xvid-1.3.2,1>`__,
      `yajl-2.1.0 <devel.html#yajl-2.1.0>`__
    | *Also listed in:* **`Misc <misc.html#es-kde-l10n-4.14.3>`__**,
      `Kde <kde.html#es-kde-l10n-4.14.3>`__

**\ `es-mythes-20140423 <https://svnweb.FreeBSD.org/ports/head/textproc/es-mythes>`__**
    | Spanish thesaurus
    | `Long
      description <https://svnweb.FreeBSD.org/ports/head/textproc/es-mythes/pkg-descr?revision=HEAD>`__
      \|
      `Changes <https://svnweb.FreeBSD.org/ports/head/textproc/es-mythes/?view=log>`__
      \| `Main Web Site <http://openthes-es.berlios.de/>`__
    | *Maintained by:* office@FreeBSD.org
    | *Also listed in:*
      **`Textproc <textproc.html#es-mythes-20140423>`__**

**\ `festvox-el11-1.4.0\_2 <https://svnweb.FreeBSD.org/ports/head/audio/festvox-el11>`__**
    | Castilian Spanish male voice for Festival
    | `Long
      description <https://svnweb.FreeBSD.org/ports/head/audio/festvox-el11/pkg-descr?revision=HEAD?revision=HEAD?revision=HEAD>`__
      \|
    ...
    | *Also listed in:* **`Audio <audio.html#festvox-el11-1.4.0_2>`__**,
      `Accessibility <accessibility.html#festvox-el11-1.4.0_2>`__
