...
The FreeBSD x86-64 port has been renamed
`amd64 <../platforms/amd64.html>`__. You should be automatically
redirected to the new project page in a few seconds. If not, please
