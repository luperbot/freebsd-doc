...
Alpha? <#AEN40>`__
2.3 `System-specific information <#AEN86>`__
2.3.1 `AXPpci33 (\`\`NoName'') <#AEN91>`__
2.3.2 `Universal Desktop Box (UDB or \`\`Multia'') <#AEN165>`__
2.3.3 `Personal Workstation (\`\`Miata'') <#AEN249>`__
2.3.4 `DEC3000 family (the \`\`Bird'' machines) <#AEN358>`__
2.3.5 `Evaluation Board 64 family <#AEN531>`__
...
\`\`Bret'' for EV56) <#AEN714>`__
2.3.9 `AlphaServer 1000 (\`\`Mikasa''), 1000A (\`\`Noritake'') and
800 <#AEN817>`__
2.3.10 `DS10/VS10/XP900 (\`\`Webbrick'') / XP1000 (\`\`Monet'') / DS10L
(\`\`Slate'') <#AEN872>`__
2.3.11 `DS20/DS20E (\`\`Goldrush'') <#AEN1023>`__
2.3.12 `AlphaPC 264DP / UP2000 <#AEN1092>`__
2.3.13 `AlphaServer 2000 (\`\`DemiSable''), 2100 (\`\`Sable''), 2100A
(\`\`Lynx'') <#AEN1138>`__
2.3.14 `AlphaServer 4x00 (\`\`Rawhide'') <#AEN1209>`__
2.3.15 `AlphaServer 1200 (\`\`Tincup'') and AlphaStation 1200
(\`\`DaVinci'') <#AEN1242>`__
2.3.16 `AlphaServer 8200 and 8400 (\`\`TurboLaser'') <#AEN1272>`__
2.3.17 `Alpha Processor Inc. UP1000 <#AEN1315>`__
2.3.18 `Alpha Processor Inc. UP1100 <#AEN1364>`__
2.3.19 `Alpha Processor Inc. CS20 <#AEN1412>`__
2.4 `Supported Hardware Overview <#AEN1459>`__
2.5 `Acknowledgments <#AEN1490>`__
3 `Supported Devices <#AEN1531>`__
3.1 `Disk Controllers <#AEN1537>`__
3.2 `Ethernet Interfaces <#ETHERNET>`__
3.3 `FDDI Interfaces <#AEN2695>`__
3.4 `ATM Interfaces <#AEN2705>`__
3.5 `Wireless Network Interfaces <#AEN2747>`__
3.6 `Miscellaneous Networks <#AEN2824>`__
3.7 `ISDN Interfaces <#AEN2830>`__
3.8 `Multi-port Serial Interfaces <#AEN2892>`__
3.9 `Audio Devices <#AEN2972>`__
3.10 `Camera and Video Capture Devices <#AEN3074>`__
3.11 `USB Devices <#USB>`__
3.12 `Miscellaneous <#AEN3251>`__
...
.. raw:: html
    ...
    **Note:** SRM commands will be in ``UPPER CASE``. Lower case input
    is also acceptible to SRM. Upper case is used for clarity.
...
fine, but the system will not be bootable from the freshly installed
disk.
...
EV67. The EVs with double digit numbers are slightly improved versions.
For example EV45 has an improved FPU and 16 kByte on-chip separate I & D
caches compared to the EV4 on which it is based. Rule of thumb: the
higher the digit immediately following \`\`EV'' the more desirable
...
`pcm(4) <http://www.FreeBSD.org/cgi/man.cgi?query=pcm&sektion=4&manpath=FreeBSD+4.5-RELEASE>`__
...
distributed over 2 banks will not work.
...
Symbios876 based cards. In addition, Adaptec 2940U and 2940UW are
...
external to the box. +++ This is what some DEC docs suggest. Did they
ever go UltraSCSI?
...
.. raw:: html
    ...
    **Note:** Contrary to expectation there is no ``cpu EV6`` defined
    ...
    mandatory to keep
    `config(8) <http://www.FreeBSD.org/cgi/man.cgi?query=config&sektion=8&manpath=FreeBSD+4.5-RELEASE>`__
    happy.
...
SRM console firmware is available from the Alpha Processor Inc. website.
It is currently available in a beta version which was successfully used
during the port of FreeBSD to the UP1000.
...
Each PCI slot is connected to it's own independent PCI bus on the
Tsunami.
...
-  Adaptec
   ...
   variants
   (`ahc(4) <http://www.FreeBSD.org/cgi/man.cgi?query=ahc&sektion=4&manpath=FreeBSD+4.5-RELEASE>`__
   driver)
...
(`amr(4) <http://www.FreeBSD.org/cgi/man.cgi?query=amr&sektion=4&manpath=FreeBSD+4.5-RELEASE>`__
driver)
...
firmware
(`mlx(4) <http://www.FreeBSD.org/cgi/man.cgi?query=mlx&sektion=4&manpath=FreeBSD+4.5-RELEASE>`__
driver)
...
(`ncr(4) <http://www.FreeBSD.org/cgi/man.cgi?query=ncr&sektion=4&manpath=FreeBSD+4.5-RELEASE>`__
and
`sym(4) <http://www.FreeBSD.org/cgi/man.cgi?query=sym&sektion=4&manpath=FreeBSD+4.5-RELEASE>`__
drivers)
...
53c974 as well
(`amd(4) <http://www.FreeBSD.org/cgi/man.cgi?query=amd&sektion=4&manpath=FreeBSD+4.5-RELEASE>`__
driver)
...
`cd(4) <http://www.FreeBSD.org/cgi/man.cgi?query=cd&sektion=4&manpath=FreeBSD+4.5-RELEASE>`__).
WORM/CD-R/CD-RW writing support is provided by
`cdrecord(1) <http://www.FreeBSD.org/cgi/man.cgi?query=cdrecord&sektion=1&manpath=FreeBSD+4.5-RELEASE>`__,
...
-  ATAPI IDE interface
   (`acd(4) <http://www.FreeBSD.org/cgi/man.cgi?query=acd&sektion=4&manpath=FreeBSD+4.5-RELEASE>`__)
...
(`sf(4) <http://www.FreeBSD.org/cgi/man.cgi?query=sf&sektion=4&manpath=FreeBSD+4.5-RELEASE>`__
driver)
...
AMD PCnet NICs
(`lnc(4) <http://www.FreeBSD.org/cgi/man.cgi?query=lnc&sektion=4&manpath=FreeBSD+4.5-RELEASE>`__
and
`pcn(4) <http://www.FreeBSD.org/cgi/man.cgi?query=pcn&sektion=4&manpath=FreeBSD+4.5-RELEASE>`__
drivers)
...
NE2000 and clones
(`ed(4) <http://www.FreeBSD.org/cgi/man.cgi?query=ed&sektion=4&manpath=FreeBSD+4.5-RELEASE>`__
driver)
...
(`rl(4) <http://www.FreeBSD.org/cgi/man.cgi?query=rl&sektion=4&manpath=FreeBSD+4.5-RELEASE>`__
driver)
...
(`wb(4) <http://www.FreeBSD.org/cgi/man.cgi?query=wb&sektion=4&manpath=FreeBSD+4.5-RELEASE>`__
driver)
...
Ethernet NICs
(`vr(4) <http://www.FreeBSD.org/cgi/man.cgi?query=vr&sektion=4&manpath=FreeBSD+4.5-RELEASE>`__
driver)
...
(`ste(4) <http://www.FreeBSD.org/cgi/man.cgi?query=ste&sektion=4&manpath=FreeBSD+4.5-RELEASE>`__
driver)

-  D-Link DFE-550TX

SysKonnect SK-984x PCI Gigabit Ethernet cards
(`sk(4) <http://www.FreeBSD.org/cgi/man.cgi?query=sk&sektion=4&manpath=FreeBSD+4.5-RELEASE>`__
drivers)
...
(`tl(4) <http://www.FreeBSD.org/cgi/man.cgi?query=tl&sektion=4&manpath=FreeBSD+4.5-RELEASE>`__
driver)
...
(3CR990) chipset
(`txp(4) <http://www.FreeBSD.org/cgi/man.cgi?query=txp&sektion=4&manpath=FreeBSD+4.5-RELEASE>`__
driver)
...
DEC DEFPA PCI
(`fpa(4) <http://www.FreeBSD.org/cgi/man.cgi?query=fpa&sektion=4&manpath=FreeBSD+4.5-RELEASE>`__
driver)
...
-  ES1868, ES1869, ES1879 and ES1888
   (`sbc(4) <http://www.FreeBSD.org/cgi/man.cgi?query=sbc&sektion=4&manpath=FreeBSD+4.5-RELEASE>`__
   driver)
...
Host Controllers
(`ohci(4) <http://www.FreeBSD.org/cgi/man.cgi?query=ohci&sektion=4&manpath=FreeBSD+4.5-RELEASE>`__
and
`uhci(4) <http://www.FreeBSD.org/cgi/man.cgi?query=uhci&sektion=4&manpath=FreeBSD+4.5-RELEASE>`__
drivers)
...
Keyboards
(`ukbd(4) <http://www.FreeBSD.org/cgi/man.cgi?query=ukbd&sektion=4&manpath=FreeBSD+4.5-RELEASE>`__
driver)
...
Mice
(`ums(4) <http://www.FreeBSD.org/cgi/man.cgi?query=ums&sektion=4&manpath=FreeBSD+4.5-RELEASE>`__
driver)
...
Storage
(`umass(4) <http://www.FreeBSD.org/cgi/man.cgi?query=umass&sektion=4&manpath=FreeBSD+4.5-RELEASE>`__
driver)
...
Floppy drives
(`fd(4) <http://www.FreeBSD.org/cgi/man.cgi?query=fd&sektion=4&manpath=FreeBSD+4.5-RELEASE>`__
driver)
...
-  PS/2 mice
   (`psm(4) <http://www.FreeBSD.org/cgi/man.cgi?query=psm&sektion=4&manpath=FreeBSD+4.5-RELEASE>`__
   driver)
...
Parallel ports
(`ppc(4) <http://www.FreeBSD.org/cgi/man.cgi?query=ppc&sektion=4&manpath=FreeBSD+4.5-RELEASE>`__
driver)

Serial ports
(`sio(4) <http://www.FreeBSD.org/cgi/man.cgi?query=sio&sektion=4&manpath=FreeBSD+4.5-RELEASE>`__
driver)
