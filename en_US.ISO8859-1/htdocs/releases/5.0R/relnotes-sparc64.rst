=========================================
FreeBSD/sparc64 5.0-RELEASE Release Notes
=========================================
...
The sab driver, which supports the Siemens SAB82532 serial chip found on
many newer Sparc Ultra machines, has been added.
...
The
`ofwdump(8) <http://www.FreeBSD.org/cgi/man.cgi?query=ofwdump&sektion=8&manpath=FreeBSD+5.0-RELEASE>`__
utility has been added to examine the OpenFirmware device tree.
