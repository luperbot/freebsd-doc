===================================
FreeBSD/pc98 5.0-DP2 Hardware Notes
===================================
...
3 `Supported Devices <#AEN19>`__
3.1 `Disk Controllers <#AEN25>`__
3.2 `Ethernet Interfaces <#ETHERNET>`__
3.3 `FDDI Interfaces <#AEN1492>`__
3.4 `ATM Interfaces <#AEN1502>`__
3.5 `Wireless Network Interfaces <#AEN1544>`__
3.6 `Miscellaneous Networks <#AEN1669>`__
3.7 `ISDN Interfaces <#AEN1679>`__
3.8 `Serial Interfaces <#AEN1743>`__
3.9 `Audio Devices <#AEN1903>`__
3.10 `Camera and Video Capture Devices <#AEN2029>`__
3.11 `USB Devices <#USB>`__
3.12 `IEEE 1394 (Firewire) Devices <#FIREWIRE>`__
3.13 `Cryptographic Accelerators <#AEN2286>`__
3.14 `Miscellaneous <#AEN2311>`__
...
5.0-DP2 on the NEC PC-98x1 hardware platform (also referred to as
FreeBSD/pc98 5.0-DP2). It lists devices known to work on this platform,
...
-  NEC PC-9801-100 and Adaptec AHA-1030P,
   1030B(\ `aic(4) <http://www.FreeBSD.org/cgi/man.cgi?query=aic&sektion=4&manpath=FreeBSD+5.0-current>`__
   driver)
