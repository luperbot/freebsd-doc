...
2.3.3 `Personal Workstation (\`\`Miata'') <#AEN272>`__
2.3.4 `DEC3000 family (the \`\`Bird'' machines) <#AEN381>`__
2.3.5 `Evaluation Board 64 family <#AEN552>`__
...
\`\`Bret'' for EV56) <#AEN734>`__
2.3.9 `AlphaServer 1000 (\`\`Mikasa''), 1000A (\`\`Noritake'') and
800(\`\`Corelle'') <#AEN844>`__
2.3.10 `DS10/VS10/XP900 (\`\`Webbrick'') / XP1000 (\`\`Monet'') / DS10L
(\`\`Slate'') <#AEN900>`__
2.3.11 `DS20/DS20E (\`\`Goldrush'') <#AEN1051>`__
2.3.12 `AlphaPC 264DP / UP2000 <#AEN1120>`__
2.3.13 `AlphaServer 2000 (\`\`DemiSable''), 2100 (\`\`Sable''), 2100A
(\`\`Lynx'') <#AEN1166>`__
2.3.14 `AlphaServer 4x00 (\`\`Rawhide'') <#AEN1237>`__
2.3.15 `AlphaServer 1200 (\`\`Tincup'') and AlphaStation 1200
(\`\`DaVinci'') <#AEN1268>`__
2.3.16 `AlphaServer 8200 and 8400 (\`\`TurboLaser'') <#AEN1298>`__
2.3.17 `Alpha Processor Inc. UP1000 <#AEN1341>`__
2.3.18 `Alpha Processor Inc. UP1100 <#AEN1390>`__
2.3.19 `Alpha Processor Inc. CS20 <#AEN1438>`__
2.4 `Supported Hardware Overview <#AEN1485>`__
2.5 `Acknowledgments <#AEN1517>`__
3 `Supported Devices <#AEN1558>`__
3.1 `Disk Controllers <#AEN1564>`__
3.2 `Ethernet Interfaces <#ETHERNET>`__
3.3 `FDDI Interfaces <#AEN2777>`__
3.4 `ATM Interfaces <#AEN2787>`__
3.5 `Wireless Network Interfaces <#AEN2829>`__
3.6 `Miscellaneous Networks <#AEN2906>`__
3.7 `ISDN Interfaces <#AEN2916>`__
3.8 `Multi-port Serial Interfaces <#AEN2980>`__
3.9 `Audio Devices <#AEN3075>`__
3.10 `Camera and Video Capture Devices <#AEN3177>`__
3.11 `USB Devices <#USB>`__
3.12 `Miscellaneous <#AEN3356>`__
...
5.0-DP1 on the Alpha/AXP hardware platform (also referred to as
FreeBSD/alpha 5.0-DP1). It lists devices known to work on this platform,
as well as some notes on boot-time kernel customization that may be
useful when attempting to configure support for new devices.
...
`pcm(4) <http://www.FreeBSD.org/cgi/man.cgi?query=pcm&sektion=4&manpath=FreeBSD+5.0-current>`__
...
You also need to specify flags 0x15 in the hints file.
...
The sound device uses port 0x530, IRQ 9 and drq 0. You also need to
...
(`amr(4) <http://www.FreeBSD.org/cgi/man.cgi?query=amr&sektion=4&manpath=FreeBSD+5.0-current>`__
driver)
...
firmware
(`mlx(4) <http://www.FreeBSD.org/cgi/man.cgi?query=mlx&sektion=4&manpath=FreeBSD+5.0-current>`__
driver)
...
(`sk(4) <http://www.FreeBSD.org/cgi/man.cgi?query=sk&sektion=4&manpath=FreeBSD+5.0-current>`__
drivers)
...
-  ES1868, ES1869, ES1879 and ES1888
   (`sbc(4) <http://www.FreeBSD.org/cgi/man.cgi?query=sbc&sektion=4&manpath=FreeBSD+5.0-current>`__
   driver)
