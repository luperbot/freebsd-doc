==========================================
FreeBSD/sparc64 5.4-RELEASE Hardware Notes
==========================================
...
5.4-RELEASE on the UltraSPARC hardware platform (also referred to as
FreeBSD/sparc64 5.4-RELEASE). It lists devices known to work on this
...
tested with FreeBSD 5.4-RELEASE. We encourage you to try it and send a
...
Cards supported by
`gem(4) <http://www.FreeBSD.org/cgi/man.cgi?query=gem&sektion=4&manpath=FreeBSD+5.4-RELEASE>`__
driver include:
