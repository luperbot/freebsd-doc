...
.. raw:: html
    ...
    This document gives a brief introduction to FreeBSD 5.4-RELEASE. It
...
This distribution is a release of FreeBSD 5.4-RELEASE, the latest point
along the 5-STABLE branch.
...
a piece of software, with a single command. Over 12,300 ports, from
...
If you're tracking the 5-STABLE development efforts, you *must* join the
...
`send-pr(1) <http://www.FreeBSD.org/cgi/man.cgi?query=send-pr&sektion=1&manpath=FreeBSD+5.4-RELEASE>`__
...
-  ``EARLY.TXT``: A migration guide for users of FreeBSD 4.\ ``X`` who
   are new to FreeBSD 5.\ ``X`` series of releases.

-  ``RELNOTES.TXT``: The release notes, showing what's new and different
   in FreeBSD 5.4-RELEASE compared to the previous release (FreeBSD
   5.3-RELEASE).
...
`man(1) <http://www.FreeBSD.org/cgi/man.cgi?query=man&sektion=1&manpath=FreeBSD+5.4-RELEASE>`__
...
`tuning(7) <http://www.FreeBSD.org/cgi/man.cgi?query=tuning&sektion=7&manpath=FreeBSD+5.4-RELEASE>`__
(a guide to performance tuning),
`security(7) <http://www.FreeBSD.org/cgi/man.cgi?query=security&sektion=7&manpath=FreeBSD+5.4-RELEASE>`__
(an introduction to FreeBSD security), and
`style(9) <http://www.FreeBSD.org/cgi/man.cgi?query=style&sektion=9&manpath=FreeBSD+5.4-RELEASE>`__
