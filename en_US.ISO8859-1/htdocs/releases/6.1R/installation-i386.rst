...
.. raw:: html
    ...
    FreeBSD/i386 6.1-RELEASE, with particular emphasis given to
...
obtaining the FreeBSD 6.1-RELEASE distribution and to beginning the
...
``release``\ ``/floppies/kernX``.flp files from
http://www.FreeBSD.org/snapshots/ or one of the many mirrors listed at
`FTP
...
`dd(1) <http://www.FreeBSD.org/cgi/man.cgi?query=dd&sektion=1&manpath=FreeBSD+6.1-RELEASE>`__
command in UNIX.
...
-  If you would be able to FTP install FreeBSD directly from the CDROM
   ...
   `vipw(8) <http://www.FreeBSD.org/cgi/man.cgi?query=vipw&sektion=8&manpath=FreeBSD+6.1-RELEASE>`__
   command):
...
-  If you would rather use NFS to export the CDROM directly to the
   ...
   `rc.conf(5) <http://www.FreeBSD.org/cgi/man.cgi?query=rc.conf&sektion=5&manpath=FreeBSD+6.1-RELEASE>`__
...
`disklabel(8) <http://www.FreeBSD.org/cgi/man.cgi?query=disklabel&sektion=8&manpath=FreeBSD+6.1-RELEASE>`__
and
`newfs(8) <http://www.FreeBSD.org/cgi/man.cgi?query=newfs&sektion=8&manpath=FreeBSD+6.1-RELEASE>`__
...
`tar(1) <http://www.FreeBSD.org/cgi/man.cgi?query=tar&sektion=1&manpath=FreeBSD+6.1-RELEASE>`__
...
6.xx ``DEFRAG`` utility or the **Norton Disk Tools**, then run FIPS. It
...
`doscmd(1) <http://www.FreeBSD.org/cgi/man.cgi?query=doscmd&sektion=1&manpath=FreeBSD+6.1-RELEASE>`__
...
`mtree(8) <http://www.FreeBSD.org/cgi/man.cgi?query=mtree&sektion=8&manpath=FreeBSD+6.1-RELEASE>`__
...
.. raw:: html
    ...
    **Warning:** Binary upgrades to FreeBSD 6.1-RELEASE from FreeBSD
    ...
    upgrading from relatively recent FreeBSD 6.1-STABLE snapshots.
