========================================
FreeBSD/alpha 6.1-RELEASE Hardware Notes
========================================
...
2.1 `Overview <#AEN29>`__
2.2 `In general, what do you need to run FreeBSD on an
Alpha? <#AEN45>`__
2.3 `System-specific information <#AEN106>`__
2.3.1 `AXPpci33 (“NoName”) <#AEN111>`__
2.3.2 `Personal Workstation (“Miata”) <#AEN186>`__
2.3.3 `Evaluation Board 64 family <#AEN296>`__
...
800(“Corelle”) <#AEN599>`__
2.3.8 `DS10/VS10/XP900 (“Webbrick”) / XP1000 (“Monet”) / DS10L
(“Slate”) <#AEN655>`__
2.3.9 `DS20/DS20E (“Goldrush”) <#AEN806>`__
2.3.10 `AlphaPC 264DP / UP2000 <#AEN875>`__
2.3.11 `AlphaServer 2000 (“DemiSable”), 2100 (“Sable”), 2100A
(“Lynx”) <#AEN921>`__
2.3.12 `AlphaServer 4x00 (“Rawhide”) <#AEN992>`__
2.3.13 `AlphaServer 1200 (“Tincup”) and AlphaStation 1200
(“DaVinci”) <#AEN1025>`__
2.3.14 `Alpha Processor Inc. UP1000 <#AEN1055>`__
2.3.15 `Alpha Processor Inc. UP1100 <#AEN1104>`__
2.3.16 `Alpha Processor Inc. CS20, Compaq DS20L <#AEN1152>`__
2.3.17 `Compaq AlphaServer ES40 (“Clipper”) <#AEN1199>`__
2.4 `Supported Hardware Overview <#AEN1236>`__
2.5 `Acknowledgments <#AEN1267>`__
...
6.1-RELEASE on the Alpha/AXP hardware platform (also referred to as
FreeBSD/alpha 6.1-RELEASE). It lists devices known to work on this
...
`de(4) <http://www.FreeBSD.org/cgi/man.cgi?query=de&sektion=4&manpath=FreeBSD+6.1-RELEASE>`__
(older driver) or
`dc(4) <http://www.FreeBSD.org/cgi/man.cgi?query=dc&sektion=4&manpath=FreeBSD+6.1-RELEASE>`__
(newer driver). Some new SRM versions are known to recognize the Intel
8255x Ethernet chips as driven by the FreeBSD
`fxp(4) <http://www.FreeBSD.org/cgi/man.cgi?query=fxp&sektion=4&manpath=FreeBSD+6.1-RELEASE>`__
...
1.282.2.9.2.2 2006/05/01 08:26:00 brueffer Exp $
...
The
`ahc(4) <http://www.FreeBSD.org/cgi/man.cgi?query=ahc&sektion=4&manpath=FreeBSD+6.1-RELEASE>`__
...
`isp(4) <http://www.FreeBSD.org/cgi/man.cgi?query=isp&sektion=4&manpath=FreeBSD+6.1-RELEASE>`__
driver include:
...
Controllers supported by the
`mlx(4) <http://www.FreeBSD.org/cgi/man.cgi?query=mlx&sektion=4&manpath=FreeBSD+6.1-RELEASE>`__
driver include:
...
`mpt(4) <http://www.FreeBSD.org/cgi/man.cgi?query=mpt&sektion=4&manpath=FreeBSD+6.1-RELEASE>`__
driver:
...
The
`ncr(4) <http://www.FreeBSD.org/cgi/man.cgi?query=ncr&sektion=4&manpath=FreeBSD+6.1-RELEASE>`__
...
The
`sym(4) <http://www.FreeBSD.org/cgi/man.cgi?query=sym&sektion=4&manpath=FreeBSD+6.1-RELEASE>`__
...
`cd(4) <http://www.FreeBSD.org/cgi/man.cgi?query=cd&sektion=4&manpath=FreeBSD+6.1-RELEASE>`__).
...
-  ATAPI IDE interface
   (`acd(4) <http://www.FreeBSD.org/cgi/man.cgi?query=acd&sektion=4&manpath=FreeBSD+6.1-RELEASE>`__)
...
The
`hme(4) <http://www.FreeBSD.org/cgi/man.cgi?query=hme&sektion=4&manpath=FreeBSD+6.1-RELEASE>`__
...
The
`nge(4) <http://www.FreeBSD.org/cgi/man.cgi?query=nge&sektion=4&manpath=FreeBSD+6.1-RELEASE>`__
...
The
`pcn(4) <http://www.FreeBSD.org/cgi/man.cgi?query=pcn&sektion=4&manpath=FreeBSD+6.1-RELEASE>`__
...
The
`re(4) <http://www.FreeBSD.org/cgi/man.cgi?query=re&sektion=4&manpath=FreeBSD+6.1-RELEASE>`__
...
Adapters supported by the
`rl(4) <http://www.FreeBSD.org/cgi/man.cgi?query=rl&sektion=4&manpath=FreeBSD+6.1-RELEASE>`__
driver include:
...
Adapters supported by the
`sf(4) <http://www.FreeBSD.org/cgi/man.cgi?query=sf&sektion=4&manpath=FreeBSD+6.1-RELEASE>`__
driver include:
...
The
`sis(4) <http://www.FreeBSD.org/cgi/man.cgi?query=sis&sektion=4&manpath=FreeBSD+6.1-RELEASE>`__
...
Adapters supported by the
`sk(4) <http://www.FreeBSD.org/cgi/man.cgi?query=sk&sektion=4&manpath=FreeBSD+6.1-RELEASE>`__
driver include:
...
The
`ste(4) <http://www.FreeBSD.org/cgi/man.cgi?query=ste&sektion=4&manpath=FreeBSD+6.1-RELEASE>`__
...
The
`tl(4) <http://www.FreeBSD.org/cgi/man.cgi?query=tl&sektion=4&manpath=FreeBSD+6.1-RELEASE>`__
...
The
`txp(4) <http://www.FreeBSD.org/cgi/man.cgi?query=txp&sektion=4&manpath=FreeBSD+6.1-RELEASE>`__
...
The
`vr(4) <http://www.FreeBSD.org/cgi/man.cgi?query=vr&sektion=4&manpath=FreeBSD+6.1-RELEASE>`__
...
The
`wb(4) <http://www.FreeBSD.org/cgi/man.cgi?query=wb&sektion=4&manpath=FreeBSD+6.1-RELEASE>`__
...
The
`xl(4) <http://www.FreeBSD.org/cgi/man.cgi?query=xl&sektion=4&manpath=FreeBSD+6.1-RELEASE>`__
driver supports the following hardware:
...
DEC DEFPA PCI
(`fpa(4) <http://www.FreeBSD.org/cgi/man.cgi?query=fpa&sektion=4&manpath=FreeBSD+6.1-RELEASE>`__
driver)
...
(`sio(4) <http://www.FreeBSD.org/cgi/man.cgi?query=sio&sektion=4&manpath=FreeBSD+6.1-RELEASE>`__
driver)

The
`uart(4) <http://www.FreeBSD.org/cgi/man.cgi?query=uart&sektion=4&manpath=FreeBSD+6.1-RELEASE>`__
...
(`rp(4) <http://www.FreeBSD.org/cgi/man.cgi?query=rp&sektion=4&manpath=FreeBSD+6.1-RELEASE>`__
driver)
...
The
`snd\_maestro(4) <http://www.FreeBSD.org/cgi/man.cgi?query=snd_maestro&sektion=4&manpath=FreeBSD+6.1-RELEASE>`__
...
The
`snd\_maestro3(4) <http://www.FreeBSD.org/cgi/man.cgi?query=snd_maestro3&sektion=4&manpath=FreeBSD+6.1-RELEASE>`__
...
The
`snd\_sbc(4) <http://www.FreeBSD.org/cgi/man.cgi?query=snd_sbc&sektion=4&manpath=FreeBSD+6.1-RELEASE>`__
...
The
`ohci(4) <http://www.FreeBSD.org/cgi/man.cgi?query=ohci&sektion=4&manpath=FreeBSD+6.1-RELEASE>`__
...
The
`uhci(4) <http://www.FreeBSD.org/cgi/man.cgi?query=uhci&sektion=4&manpath=FreeBSD+6.1-RELEASE>`__
...
Keyboards
(`ukbd(4) <http://www.FreeBSD.org/cgi/man.cgi?query=ukbd&sektion=4&manpath=FreeBSD+6.1-RELEASE>`__
driver)

Mice
(`ums(4) <http://www.FreeBSD.org/cgi/man.cgi?query=ums&sektion=4&manpath=FreeBSD+6.1-RELEASE>`__
driver)

The
`ulpt(4) <http://www.FreeBSD.org/cgi/man.cgi?query=ulpt&sektion=4&manpath=FreeBSD+6.1-RELEASE>`__
...
The
`umct(4) <http://www.FreeBSD.org/cgi/man.cgi?query=umct&sektion=4&manpath=FreeBSD+6.1-RELEASE>`__
...
The
`umass(4) <http://www.FreeBSD.org/cgi/man.cgi?query=umass&sektion=4&manpath=FreeBSD+6.1-RELEASE>`__
...
Floppy drives
(`fdc(4) <http://www.FreeBSD.org/cgi/man.cgi?query=fdc&sektion=4&manpath=FreeBSD+6.1-RELEASE>`__
driver)

VGA-compatible video cards
(`vga(4) <http://www.FreeBSD.org/cgi/man.cgi?query=vga&sektion=4&manpath=FreeBSD+6.1-RELEASE>`__
driver)
...
-  AT-style keyboards
   (`atkbd(4) <http://www.FreeBSD.org/cgi/man.cgi?query=atkbd&sektion=4&manpath=FreeBSD+6.1-RELEASE>`__
   driver)
...
-  PS/2 mice and compatible devices, including many laptop pointing
   devices
   (`psm(4) <http://www.FreeBSD.org/cgi/man.cgi?query=psm&sektion=4&manpath=FreeBSD+6.1-RELEASE>`__
   driver)
...
(`ppc(4) <http://www.FreeBSD.org/cgi/man.cgi?query=ppc&sektion=4&manpath=FreeBSD+6.1-RELEASE>`__
driver)
