=========================================
FreeBSD/pc98 5.2.1-RELEASE Hardware Notes
=========================================
...
5.2.1-RELEASE on the NEC PC-98x1 hardware platform (also referred to as
FreeBSD/pc98 5.2.1-RELEASE). It lists devices known to work on this
...
(`sb(4) <http://www.FreeBSD.org/cgi/man.cgi?query=sb&sektion=4&manpath=FreeBSD+5.2.1-RELEASE>`__
driver)
