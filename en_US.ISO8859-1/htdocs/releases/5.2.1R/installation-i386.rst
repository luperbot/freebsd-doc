====================================================
FreeBSD/i386 5.2.1-RELEASE Installation Instructions
====================================================
...
.. raw:: html
    ...
    FreeBSD/i386 5.2.1-RELEASE, with particular emphasis given to
...
release\ ``/floppies/drivers.flp`` files from ftp://ftp.FreeBSD.org/ or
...
`dd(1) <http://www.FreeBSD.org/cgi/man.cgi?query=dd&sektion=1&manpath=FreeBSD+5.2.1-RELEASE>`__
command in UNIX.
...
-  If you would be able to FTP install FreeBSD directly from the CDROM
   ...
   `vipw(8) <http://www.FreeBSD.org/cgi/man.cgi?query=vipw&sektion=8&manpath=FreeBSD+5.2.1-RELEASE>`__
   command):
...
-  If you would rather use NFS to export the CDROM directly to the
   ...
   `rc.conf(5) <http://www.FreeBSD.org/cgi/man.cgi?query=rc.conf&sektion=5&manpath=FreeBSD+5.2.1-RELEASE>`__
...
`disklabel(8) <http://www.FreeBSD.org/cgi/man.cgi?query=disklabel&sektion=8&manpath=FreeBSD+5.2.1-RELEASE>`__
and
`newfs(8) <http://www.FreeBSD.org/cgi/man.cgi?query=newfs&sektion=8&manpath=FreeBSD+5.2.1-RELEASE>`__
...
`tar(1) <http://www.FreeBSD.org/cgi/man.cgi?query=tar&sektion=1&manpath=FreeBSD+5.2.1-RELEASE>`__
...
`doscmd(1) <http://www.FreeBSD.org/cgi/man.cgi?query=doscmd&sektion=1&manpath=FreeBSD+5.2.1-RELEASE>`__
...
#. The ``packages`` and ``ports`` directories contain the FreeBSD
   ...
   ``packages``/ to the
   `pkg\_add(1) <http://www.FreeBSD.org/cgi/man.cgi?query=pkg_add&sektion=1&manpath=FreeBSD+5.2.1-RELEASE>`__
   command.
...
`mtree(8) <http://www.FreeBSD.org/cgi/man.cgi?query=mtree&sektion=8&manpath=FreeBSD+5.2.1-RELEASE>`__
...
.. raw:: html
    ...
    **Warning:** Binary upgrades to FreeBSD 5.2.1-RELEASE from FreeBSD
...
boot menu each time but the boot won't go any further. <#Q4.2.4.>`__
...
\ **4.2.13.** When installing on a Dell Poweredge XE, Dell proprietary
