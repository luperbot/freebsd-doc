...
.. raw:: html
    ...
    FreeBSD/i386 5.1-RELEASE, with particular emphasis given to
...
`dd(1) <http://www.FreeBSD.org/cgi/man.cgi?query=dd&sektion=1&manpath=FreeBSD+5.1-release>`__
command in UNIX.
...
`doscmd(1) <http://www.FreeBSD.org/cgi/man.cgi?query=doscmd&sektion=1&manpath=FreeBSD+5.1-release>`__
...
.. raw:: html
    ...
    **Warning:** Binary upgrades to FreeBSD 5.1-RELEASE from FreeBSD
