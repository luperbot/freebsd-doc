...
| $FreeBSD: src/release/doc/en\_US.ISO8859-1/readme/article.sgml,v 1.26
...
a piece of software, with a single command. Over 8,500 ports, from
...
-  ``EARLY.TXT``: A guide for early adopters of FreeBSD 5.1-RELEASE.
...
-  ``RELNOTES.TXT``: The release notes, showing what's new and different
   in FreeBSD 5.1-RELEASE compared to the previous release (FreeBSD
   5.0-RELEASE).
