...
.. raw:: html
    ...
    FreeBSD/sparc64 5.2-RELEASE, with particular emphasis given to
...
`tip(1) <http://www.FreeBSD.org/cgi/man.cgi?query=tip&sektion=1&manpath=FreeBSD+5.2-RELEASE>`__
or
`cu(1) <http://www.FreeBSD.org/cgi/man.cgi?query=cu&sektion=1&manpath=FreeBSD+5.2-RELEASE>`__)
