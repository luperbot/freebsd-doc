========================================
FreeBSD/alpha 4.7-RELEASE Hardware Notes
========================================
...
2.3.4 `DEC3000 family (the \`\`Bird'' machines) <#AEN379>`__
2.3.5 `Evaluation Board 64 family <#AEN550>`__
...
\`\`Bret'' for EV56) <#AEN733>`__
2.3.9 `AlphaServer 1000 (\`\`Mikasa''), 1000A (\`\`Noritake'') and
800(\`\`Corelle'') <#AEN843>`__
2.3.10 `DS10/VS10/XP900 (\`\`Webbrick'') / XP1000 (\`\`Monet'') / DS10L
(\`\`Slate'') <#AEN899>`__
2.3.11 `DS20/DS20E (\`\`Goldrush'') <#AEN1050>`__
2.3.12 `AlphaPC 264DP / UP2000 <#AEN1119>`__
2.3.13 `AlphaServer 2000 (\`\`DemiSable''), 2100 (\`\`Sable''), 2100A
(\`\`Lynx'') <#AEN1165>`__
2.3.14 `AlphaServer 4x00 (\`\`Rawhide'') <#AEN1236>`__
2.3.15 `AlphaServer 1200 (\`\`Tincup'') and AlphaStation 1200
(\`\`DaVinci'') <#AEN1267>`__
2.3.16 `AlphaServer 8200 and 8400 (\`\`TurboLaser'') <#AEN1297>`__
2.3.17 `Alpha Processor Inc. UP1000 <#AEN1340>`__
2.3.18 `Alpha Processor Inc. UP1100 <#AEN1389>`__
2.3.19 `Alpha Processor Inc. CS20, Compaq DS20L <#AEN1437>`__
2.4 `Supported Hardware Overview <#AEN1484>`__
2.5 `Acknowledgments <#AEN1516>`__
3 `Supported Devices <#AEN1557>`__
3.1 `Disk Controllers <#AEN1563>`__
3.2 `Ethernet Interfaces <#ETHERNET>`__
3.3 `FDDI Interfaces <#AEN2828>`__
3.4 `ATM Interfaces <#AEN2838>`__
3.5 `Wireless Network Interfaces <#AEN2880>`__
3.6 `Miscellaneous Networks <#AEN3005>`__
3.7 `ISDN Interfaces <#AEN3015>`__
3.8 `Multi-port Serial Interfaces <#AEN3079>`__
3.9 `Audio Devices <#AEN3179>`__
3.10 `Camera and Video Capture Devices <#AEN3281>`__
3.11 `USB Devices <#USB>`__
3.12 `Miscellaneous <#AEN3487>`__
...
4.7-RELEASE on the Alpha/AXP hardware platform (also referred to as
FreeBSD/alpha 4.7-RELEASE). It lists devices known to work on this
