...
-  Matsushita/Panasonic (Creative SoundBlaster) proprietary interface
   (562/563 models)
   (`matcd(4) <http://www.FreeBSD.org/cgi/man.cgi?query=matcd&sektion=4>`__)
...
(`rdp(4) <http://www.FreeBSD.org/cgi/man.cgi?query=rdp&sektion=4>`__
driver)
...
-  3C501
   (`el(4) <http://www.FreeBSD.org/cgi/man.cgi?query=el&sektion=4>`__
   driver)
...
(`ray(4) <http://www.FreeBSD.org/cgi/man.cgi?query=ray&sektion=4>`__
driver)
...
ARNET serial cards
(`ar(4) <http://www.FreeBSD.org/cgi/man.cgi?query=ar&sektion=4>`__
driver)
...
-  SDL Communications RISCom/N2 and N2pci high-speed sync serial boards
   (`sr(4) <http://www.FreeBSD.org/cgi/man.cgi?query=sr&sektion=4>`__
   driver)

Stallion Technologies multiport serial boards

-  EasyIO
   (`stl(4) <http://www.FreeBSD.org/cgi/man.cgi?query=stl&sektion=4>`__
   driver)
...
-  EasyConnection 8/64
   (`stli(4) <http://www.FreeBSD.org/cgi/man.cgi?query=stli&sektion=4>`__
   driver)
...
(`tw(4) <http://www.FreeBSD.org/cgi/man.cgi?query=tw&sektion=4>`__
driver)
