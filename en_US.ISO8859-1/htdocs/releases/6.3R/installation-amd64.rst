...
.. raw:: html
    ...
    FreeBSD/amd64 6.3-RELEASE, with particular emphasis given to
...
the “hint.apic.0.disabled” hint instead. If you have the option in the
bios, try disabling the APIC support. Unfortunately some machines lack
this option.
