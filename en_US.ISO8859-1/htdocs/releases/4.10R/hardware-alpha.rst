...
\`\`Bret'' for EV56) <#AEN735>`__
2.3.9 `AlphaServer 1000 (\`\`Mikasa''), 1000A (\`\`Noritake'') and
800(\`\`Corelle'') <#AEN846>`__
2.3.10 `DS10/VS10/XP900 (\`\`Webbrick'') / XP1000 (\`\`Monet'') / DS10L
(\`\`Slate'') <#AEN902>`__
2.3.11 `DS20/DS20E (\`\`Goldrush'') <#AEN1053>`__
2.3.12 `AlphaPC 264DP / UP2000 <#AEN1122>`__
2.3.13 `AlphaServer 2000 (\`\`DemiSable''), 2100 (\`\`Sable''), 2100A
(\`\`Lynx'') <#AEN1168>`__
2.3.14 `AlphaServer 4x00 (\`\`Rawhide'') <#AEN1239>`__
...
3.3 `FDDI Interfaces <#AEN2914>`__
3.4 `ATM Interfaces <#AEN2924>`__
3.5 `Wireless Network Interfaces <#AEN2966>`__
3.6 `Miscellaneous Networks <#AEN3094>`__
3.7 `ISDN Interfaces <#AEN3137>`__
3.8 `Multi-port Serial Interfaces <#AEN3201>`__
3.9 `Audio Devices <#AEN3333>`__
3.10 `Camera and Video Capture Devices <#AEN3436>`__
3.11 `USB Devices <#USB>`__
3.12 `IEEE 1394 (Firewire) Devices <#FIREWIRE>`__
3.13 `Cryptographic Accelerators <#AEN3697>`__
3.14 `Miscellaneous <#AEN3722>`__
...
4.10-RELEASE on the Alpha/AXP hardware platform (also referred to as
FreeBSD/alpha 4.10-RELEASE). It lists devices known to work on this
...
.. raw:: html
    ...
    **Note:** Contrary to expectation there is no cpu EV6 defined for
    ...
    keep
    `config(8) <http://www.FreeBSD.org/cgi/man.cgi?query=config&sektion=8&manpath=FreeBSD+4.10-RELEASE>`__
    happy.
