...
been added (or changed) since 4.9-RELEASE. It also provides some notes
...
driver for Cronyx Sigma synchronous / asynchronous serial adapters has
been updated to version 4.4.0.
...
outside the FreeBSD source tree.
...
The
`twa(4) <http://www.FreeBSD.org/cgi/man.cgi?query=twa&sektion=4&manpath=FreeBSD+4.10-RELEASE>`__
...
The
`sconfig(8) <http://www.FreeBSD.org/cgi/man.cgi?query=sconfig&sektion=8&manpath=FreeBSD+4.10-RELEASE>`__
utility was added as a part of
`cx(4) <http://www.FreeBSD.org/cgi/man.cgi?query=cx&sektion=4&manpath=FreeBSD+4.10-RELEASE>`__
driver update. It replaces the cxconfig utility for managing
`cx(4) <http://www.FreeBSD.org/cgi/man.cgi?query=cx&sektion=4&manpath=FreeBSD+4.10-RELEASE>`__
devices.
