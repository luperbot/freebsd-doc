===================================================
FreeBSD/alpha 5.3-RELEASE Installation Instructions
===================================================
...
.. raw:: html
    ...
    FreeBSD/alpha 5.3-RELEASE, with particular emphasis given to
...
prompt (>>>), just insert the ``boot.flp`` floppy and type the following
