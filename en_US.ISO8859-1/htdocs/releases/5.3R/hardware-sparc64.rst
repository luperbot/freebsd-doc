==========================================
FreeBSD/sparc64 5.3-RELEASE Hardware Notes
==========================================
...
2.1 `Fully Supported Systems <#AEN26>`__
2.2 `Partially Supported Systems <#AEN76>`__
2.3 `Unsupported Systems <#AEN88>`__
...
5.3-RELEASE on the UltraSPARC hardware platform (also referred to as
FreeBSD/sparc64 5.3-RELEASE). It lists devices known to work on this
...
tested with FreeBSD 5.3-RELEASE. We encourage you to try it and send a
