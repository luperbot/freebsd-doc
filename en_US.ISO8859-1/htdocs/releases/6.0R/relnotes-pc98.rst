======================================
FreeBSD/pc98 6.0-RELEASE Release Notes
======================================
...
The
`wd(4) <http://www.FreeBSD.org/cgi/man.cgi?query=wd&sektion=4&manpath=FreeBSD+6.0-RELEASE>`__
driver has been removed. The
`ata(4) <http://www.FreeBSD.org/cgi/man.cgi?query=ata&sektion=4&manpath=FreeBSD+6.0-RELEASE>`__
driver has been found to work well enough on the pc98 platform that
there is no need for the older
`wd(4) <http://www.FreeBSD.org/cgi/man.cgi?query=wd&sektion=4&manpath=FreeBSD+6.0-RELEASE>`__
driver.
