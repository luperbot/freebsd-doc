...
| $FreeBSD: src/release/doc/en\_US.ISO8859-1/readme/article.sgml,v 1.40
  2007/08/18 17:11:14 bmah Exp $
...
.. raw:: html
    ...
    This document gives a brief introduction to FreeBSD 7.0-RELEASE. It
...
This distribution is a snapshot of FreeBSD 7.0-RELEASE, the latest point
along the 7-STABLE branch.
...
(sparc64). Versions for the PowerPC® (powerpc), and MIPS® (mips)
...
a piece of software, with a single command. Over 18,000 ports, from
...
If you're tracking the 7-STABLE development efforts, you *must* join the
...
`send-pr(1) <http://www.FreeBSD.org/cgi/man.cgi?query=send-pr&sektion=1&manpath=FreeBSD+7.0-RELEASE>`__
...
-  ``RELNOTES.TXT``: The release notes, showing what's new and different
   in FreeBSD 7.0-RELEASE compared to the previous release (FreeBSD
   6.0-RELEASE).
...
`man(1) <http://www.FreeBSD.org/cgi/man.cgi?query=man&sektion=1&manpath=FreeBSD+7.0-RELEASE>`__
...
`tuning(7) <http://www.FreeBSD.org/cgi/man.cgi?query=tuning&sektion=7&manpath=FreeBSD+7.0-RELEASE>`__
(a guide to performance tuning),
`security(7) <http://www.FreeBSD.org/cgi/man.cgi?query=security&sektion=7&manpath=FreeBSD+7.0-RELEASE>`__
(an introduction to FreeBSD security), and
`style(9) <http://www.FreeBSD.org/cgi/man.cgi?query=style&sektion=9&manpath=FreeBSD+7.0-RELEASE>`__
