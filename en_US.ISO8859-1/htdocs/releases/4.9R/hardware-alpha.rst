========================================
FreeBSD/alpha 4.9-RELEASE Hardware Notes
========================================
...
3.7 `ISDN Interfaces <#AEN3113>`__
3.8 `Multi-port Serial Interfaces <#AEN3177>`__
3.9 `Audio Devices <#AEN3309>`__
3.10 `Camera and Video Capture Devices <#AEN3412>`__
3.11 `USB Devices <#USB>`__
3.12 `IEEE 1394 (Firewire) Devices <#FIREWIRE>`__
3.13 `Cryptographic Accelerators <#AEN3673>`__
3.14 `Miscellaneous <#AEN3698>`__
...
4.9-RELEASE on the Alpha/AXP hardware platform (also referred to as
FreeBSD/alpha 4.9-RELEASE). It lists devices known to work on this
...
.. raw:: html
    ...
    **Note:** Contrary to expectation there is no cpu EV6 defined for
    ...
    keep
    `config(8) <http://www.FreeBSD.org/cgi/man.cgi?query=config&sektion=8&manpath=FreeBSD+4.9-RELEASE>`__
    happy.
...
1.13.2.90 2003/10/01 20:36:57 simon Exp $
