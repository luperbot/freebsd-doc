...
| $FreeBSD:
  release/9.1.0/release/doc/en\_US.ISO8859-1/readme/article.sgml 243705
  2012-11-30 16:15:35Z hrs $
...
.. raw:: html
    ...
    This document gives a brief introduction to FreeBSD 9.1-RELEASE. It
...
This distribution is a release of FreeBSD 9.1-RELEASE, the latest point
along the 9.1-STABLE branch.
...
If you're tracking the 9.1-STABLE development efforts, you *must* join
...
`send-pr(1) <http://www.FreeBSD.org/cgi/man.cgi?query=send-pr&sektion=1&manpath=FreeBSD+9.1-RELEASE>`__
...
-  ``RELNOTES.TXT``: The release notes, showing what's new and different
   in FreeBSD 9.1-RELEASE compared to the previous release (FreeBSD
   9.0-RELEASE).
...
`man(1) <http://www.FreeBSD.org/cgi/man.cgi?query=man&sektion=1&manpath=FreeBSD+9.1-RELEASE>`__
...
`tuning(7) <http://www.FreeBSD.org/cgi/man.cgi?query=tuning&sektion=7&manpath=FreeBSD+9.1-RELEASE>`__
(a guide to performance tuning),
`security(7) <http://www.FreeBSD.org/cgi/man.cgi?query=security&sektion=7&manpath=FreeBSD+9.1-RELEASE>`__
(an introduction to FreeBSD security), and
`style(9) <http://www.FreeBSD.org/cgi/man.cgi?query=style&sektion=9&manpath=FreeBSD+9.1-RELEASE>`__
