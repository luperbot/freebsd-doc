...
been added (or changed) since 4.7-RELEASE. It also provides some notes
...
logical processors on HTT-capable machines. The logical processors will
be treated like additional physical processors for the purposes of
process scheduling.
...
driver has been removed due to concerns over its licensing terms. These
issues are being addressed and this driver may reappear in a future
release of FreeBSD. (This removal actually occurred in 4.7-RELEASE, but
