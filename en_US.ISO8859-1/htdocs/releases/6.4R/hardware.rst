==================================
FreeBSD 6.4-RELEASE Hardware Notes
==================================
...
as many devices are only supported on (or are only relevant for)
specific processors or architectures.

Hardware notes for FreeBSD 6.4-RELEASE are available for the following
platforms:

-  `alpha <hardware-alpha.html>`__
-  `amd64 <hardware-amd64.html>`__
-  `i386 <hardware-i386.html>`__
-  `pc98 <hardware-pc98.html>`__
-  `powerpc <hardware-powerpc.html>`__
