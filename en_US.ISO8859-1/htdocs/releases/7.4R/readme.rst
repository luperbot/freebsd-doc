...
| $FreeBSD: stable/7/release/doc/en\_US.ISO8859-1/readme/article.sgml
...
.. raw:: html
    ...
    This document gives a brief introduction to FreeBSD 7.4-RELEASE. It
...
This distribution is a release of FreeBSD 7.4-RELEASE, the latest point
along the 7.4-STABLE branch.
...
If you're tracking the 7.4-STABLE development efforts, you *must* join
...
`send-pr(1) <http://www.FreeBSD.org/cgi/man.cgi?query=send-pr&sektion=1&manpath=FreeBSD+7.4-RELEASE>`__
...
-  ``RELNOTES.TXT``: The release notes, showing what's new and different
   in FreeBSD 7.4-RELEASE compared to the previous release (FreeBSD
   7.3-RELEASE).
...
`man(1) <http://www.FreeBSD.org/cgi/man.cgi?query=man&sektion=1&manpath=FreeBSD+7.4-RELEASE>`__
...
`tuning(7) <http://www.FreeBSD.org/cgi/man.cgi?query=tuning&sektion=7&manpath=FreeBSD+7.4-RELEASE>`__
(a guide to performance tuning),
`security(7) <http://www.FreeBSD.org/cgi/man.cgi?query=security&sektion=7&manpath=FreeBSD+7.4-RELEASE>`__
(an introduction to FreeBSD security), and
`style(9) <http://www.FreeBSD.org/cgi/man.cgi?query=style&sektion=9&manpath=FreeBSD+7.4-RELEASE>`__
