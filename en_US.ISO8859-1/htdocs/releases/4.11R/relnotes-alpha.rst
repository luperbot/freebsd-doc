...
have been added (or changed) since 4.10-RELEASE. It also provides some
...
driver has been added to the kernel on the installation media.
...
Support for the floppy interface is broken on DS10-class systems. The
kernel probes the hardware correctly but the floppy does not work
properly. Booting and installing from floppies is not affected.
