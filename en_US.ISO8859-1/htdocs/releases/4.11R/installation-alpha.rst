====================================================
FreeBSD/alpha 4.11-RELEASE Installation Instructions
====================================================
...
.. raw:: html
    ...
    FreeBSD/alpha 4.11-RELEASE, with particular emphasis given to
...
prompt (>>>), just insert the ``kern.flp`` floppy and type the following
