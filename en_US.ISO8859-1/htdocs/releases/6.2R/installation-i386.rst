...
.. raw:: html
    ...
    FreeBSD/i386 6.2-RELEASE, with particular emphasis given to
...
obtaining the FreeBSD 6.2-RELEASE distribution and to beginning the
...
`dd(1) <http://www.FreeBSD.org/cgi/man.cgi?query=dd&sektion=1&manpath=FreeBSD+6.2-RELEASE>`__
command in UNIX.
...
-  If you would be able to FTP install FreeBSD directly from the CDROM
   ...
   `vipw(8) <http://www.FreeBSD.org/cgi/man.cgi?query=vipw&sektion=8&manpath=FreeBSD+6.2-RELEASE>`__
   command):
...
`disklabel(8) <http://www.FreeBSD.org/cgi/man.cgi?query=disklabel&sektion=8&manpath=FreeBSD+6.2-RELEASE>`__
and
`newfs(8) <http://www.FreeBSD.org/cgi/man.cgi?query=newfs&sektion=8&manpath=FreeBSD+6.2-RELEASE>`__
...
`doscmd(1) <http://www.FreeBSD.org/cgi/man.cgi?query=doscmd&sektion=1&manpath=FreeBSD+6.2-RELEASE>`__
...
`mtree(8) <http://www.FreeBSD.org/cgi/man.cgi?query=mtree&sektion=8&manpath=FreeBSD+6.2-RELEASE>`__
...
.. raw:: html
    ...
    **Warning:** Binary upgrades to FreeBSD 6.2-RELEASE from FreeBSD
    ...
    upgrading from relatively recent FreeBSD 6.2-STABLE snapshots.
