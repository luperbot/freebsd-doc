...
6.2-RELEASE on the Alpha/AXP hardware platform (also referred to as
FreeBSD/alpha 6.2-RELEASE). It lists devices known to work on this
...
.. raw:: html
    ...
    **Note:** Contrary to expectation there is no ``cpu EV6`` defined
    ...
    mandatory to keep
    `config(8) <http://www.FreeBSD.org/cgi/man.cgi?query=config&sektion=8&manpath=FreeBSD+6.2-RELEASE>`__
    happy.
